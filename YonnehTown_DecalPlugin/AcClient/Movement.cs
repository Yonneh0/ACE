...
namespace AcClient {
    ...
    public unsafe struct CMotionInterp {
        ...
        public void MotionDone(int success) => ((delegate* unmanaged[Thiscall]<ref CMotionInterp, int, void>)0x00527EC0)(ref this, success); // .text:00527EC0 ; void __thiscall CMotionInterp::MotionDone(CMotionInterp *this, int success) .text:00527EC0 ?MotionDone@CMotionInterp@@QAEXH@Z
