...
namespace AcClient {
    ...
    public unsafe struct StringInfo {
        ...
        public override string ToString() => $"m_strToken(PStringBase<char>):{m_strToken}, m_stringID:{m_stringID:X8}, m_tableID:{m_tableID:X8}, m_variables(HashTable<UInt32,StringInfoData*,0>):{m_variables}, m_LiteralValue:{m_LiteralValue}, m_Override(char):{m_Override}, m_strEnglish(PStringBase<char>):{m_strEnglish}, m_strComment(PStringBase<char>):{m_strComment}";
        // Enums:
        public enum StringInfo_Override_Flag : UInt32 {
            SI_NONE = 0x0,
            SI_LITERAL = 0x1,
            SI_AUTOGEN = 0x2,
        };
        ...
        // StringInfo.__Ctor:
        public void __Ctor(StringInfo* copy) => ((delegate* unmanaged[Thiscall]<ref StringInfo, StringInfo*, void>)0x0042E510)(ref this, copy); // .text:0042E2F0 ; void __thiscall StringInfo::StringInfo(StringInfo *this, StringInfo *copy) .text:0042E2F0 ??0StringInfo@@QAE@ABV0@@Z

        // StringInfo.__Ctor:
        public void __Ctor() => ((delegate* unmanaged[Thiscall]<ref StringInfo, void>)0x0042DC80)(ref this); // .text:0042DA60 ; void __thiscall StringInfo::StringInfo(StringInfo *this) .text:0042DA60 ??0StringInfo@@QAE@XZ

        // StringInfo.operator_equals:
        public int operator_equals(int a1) => ((delegate* unmanaged[Thiscall]<ref StringInfo, int, int>)0x0042DE30)(ref this, a1); // .text:0042DC10 ; int __thiscall StringInfo::operator=(StringInfo *this, int) .text:0042DC10 ??4StringInfo@@QAEABV0@ABV0@@Z

        // StringInfo.operator_is_equal:
        // public Byte operator_is_equal(StringInfo* comp) => ((delegate* unmanaged[Thiscall]<ref StringInfo, StringInfo*, Byte>)0xDEADBEEF)(ref this, comp); // .text:0042D320 ; bool __thiscall StringInfo::operator==(StringInfo *this, StringInfo *comp) .text:0042D320 ??8StringInfo@@QBE_NABV0@@Z

        // StringInfo.AddVar:
        // public void AddVar(StringInfoData* i_pcNewData) => ((delegate* unmanaged[Thiscall]<ref StringInfo, StringInfoData*, void>)0xDEADBEEF)(ref this, i_pcNewData); // .text:0042D940 ; void __thiscall StringInfo::AddVar(StringInfo *this, StringInfoData *i_pcNewData) .text:0042D940 ?AddVar@StringInfo@@IAEXPAVStringInfoData@@@Z

        // StringInfo.AddVariable_Float:
        public void AddVariable_Float(UInt32 _varID, Double _varValue, UInt16 _precision) => ((delegate* unmanaged[Thiscall]<ref StringInfo, UInt32, Double, UInt16, void>)0x0042E080)(ref this, _varID, _varValue, _precision); // .text:0042DE60 ; void __thiscall StringInfo::AddVariable_Float(StringInfo *this, unsigned int _varID, long double _varValue, unsigned __int16 _precision) .text:0042DE60 ?AddVariable_Float@StringInfo@@QAEXKNG@Z

        // StringInfo.AddVariable_Int:
        public void AddVariable_Int(UInt32 _varID, Int64 _varValue) => ((delegate* unmanaged[Thiscall]<ref StringInfo, UInt32, Int64, void>)0x0042E000)(ref this, _varID, _varValue); // .text:0042DDE0 ; void __thiscall StringInfo::AddVariable_Int(StringInfo *this, unsigned int _varID, __int64 _varValue) .text:0042DDE0 ?AddVariable_Int@StringInfo@@QAEXK_J@Z

        // StringInfo.AddVariable_String:
        public void AddVariable_String(UInt32 _varID, PStringBase<char> _varValue) => ((delegate* unmanaged[Thiscall]<ref StringInfo, UInt32, PStringBase<char>, void>)0x0042E9F0)(ref this, _varID, _varValue); // .text:0042E7D0 ; void __thiscall StringInfo::AddVariable_String(StringInfo *this, unsigned int _varID, PStringBase<char> _varValue) .text:0042E7D0 ?AddVariable_String@StringInfo@@QAEXKV?$PStringBase@D@@@Z

        // StringInfo.AddVariable_String:
        public void AddVariable_String(UInt32 _varID, PStringBase<UInt16> _varValue) => ((delegate* unmanaged[Thiscall]<ref StringInfo, UInt32, PStringBase<UInt16>, void>)0x0042E8E0)(ref this, _varID, _varValue); // .text:0042E6C0 ; void __thiscall StringInfo::AddVariable_String(StringInfo *this, unsigned int _varID, PStringBase<unsigned short> _varValue) .text:0042E6C0 ?AddVariable_String@StringInfo@@QAEXKV?$PStringBase@G@@@Z

        // StringInfo.AddVariable_StringInfo:
        public void AddVariable_StringInfo(UInt32 _varID, StringInfo* _si) => ((delegate* unmanaged[Thiscall]<ref StringInfo, UInt32, StringInfo*, void>)0x0042E660)(ref this, _varID, _si); // .text:0042E440 ; void __thiscall StringInfo::AddVariable_StringInfo(StringInfo *this, unsigned int _varID, StringInfo *_si) .text:0042E440 ?AddVariable_StringInfo@StringInfo@@QAEXKABV1@@Z

        // StringInfo.AddVariable_UInt:
        public void AddVariable_UInt(UInt32 _varID, UInt64 _varValue) => ((delegate* unmanaged[Thiscall]<ref StringInfo, UInt32, UInt64, void>)0x0042E040)(ref this, _varID, _varValue); // .text:0042DE20 ; void __thiscall StringInfo::AddVariable_UInt(StringInfo *this, unsigned int _varID, unsigned __int64 _varValue) .text:0042DE20 ?AddVariable_UInt@StringInfo@@QAEXK_K@Z

        // StringInfo.ClearVars:
        // public void ClearVars() => ((delegate* unmanaged[Thiscall]<ref StringInfo, void>)0xDEADBEEF)(ref this); // .text:0042D8D0 ; void __thiscall StringInfo::ClearVars(StringInfo *this) .text:0042D8D0 ?ClearVars@StringInfo@@IAEXXZ

        // StringInfo.FromFileNode:
        // public Byte FromFileNode(PFileNode* _node) => ((delegate* unmanaged[Thiscall]<ref StringInfo, PFileNode*, Byte>)0xDEADBEEF)(ref this, _node); // .text:0042CE00 ; bool __thiscall StringInfo::FromFileNode(StringInfo *this, PFileNode *_node) .text:0042CE00 ?FromFileNode@StringInfo@@QAE_NPBVPFileNode@@@Z

        // StringInfo.GetLiteralValue:
        // public PStringBase<UInt16>* GetLiteralValue(PStringBase<UInt16>* result, Byte bRetainMetas) => ((delegate* unmanaged[Thiscall]<ref StringInfo, PStringBase<UInt16>*, Byte, PStringBase<UInt16>*>)0xDEADBEEF)(ref this, result, bRetainMetas); // .text:0042CA50 ; PStringBase<unsigned short> *__thiscall StringInfo::GetLiteralValue(StringInfo *this, PStringBase<unsigned short> *result, bool bRetainMetas) .text:0042CA50 ?GetLiteralValue@StringInfo@@QBE?AV?$PStringBase@G@@_N@Z

        // StringInfo.GetLogString:
        public PStringBase<UInt16>* GetLogString(PStringBase<UInt16>* result, Byte _bRetainMetaTags) => ((delegate* unmanaged[Thiscall]<ref StringInfo, PStringBase<UInt16>*, Byte, PStringBase<UInt16>*>)0x0042E740)(ref this, result, _bRetainMetaTags); // .text:0042E520 ; PStringBase<unsigned short> *__thiscall StringInfo::GetLogString(StringInfo *this, PStringBase<unsigned short> *result, bool _bRetainMetaTags) .text:0042E520 ?GetLogString@StringInfo@@QBE?AV?$PStringBase@G@@_N@Z

        // StringInfo.GetString:
        public PStringBase<UInt16>* GetString(PStringBase<UInt16>* result, Byte bRetainMetas) => ((delegate* unmanaged[Thiscall]<ref StringInfo, PStringBase<UInt16>*, Byte, PStringBase<UInt16>*>)0x0042E980)(ref this, result, bRetainMetas); // .text:0042E760 ; PStringBase<unsigned short> *__thiscall StringInfo::GetString(StringInfo *this, PStringBase<unsigned short> *result, bool bRetainMetas) .text:0042E760 ?GetString@StringInfo@@QBE?AV?$PStringBase@G@@_N@Z

        // StringInfo.GetSubDataIDs:
        // public void GetSubDataIDs(QualifiedDataIDArray* id_array) => ((delegate* unmanaged[Thiscall]<ref StringInfo, QualifiedDataIDArray*, void>)0xDEADBEEF)(ref this, id_array); // .text:0042CCB0 ; void __thiscall StringInfo::GetSubDataIDs(StringInfo *this, QualifiedDataIDArray *id_array) .text:0042CCB0 ?GetSubDataIDs@StringInfo@@QBEXAAVQualifiedDataIDArray@@@Z

        // StringInfo.GetSubPrivateIDs:
        // public void GetSubPrivateIDs(QualifiedDataIDArray* id_array, UInt32 fromTable) => ((delegate* unmanaged[Thiscall]<ref StringInfo, QualifiedDataIDArray*, UInt32, void>)0xDEADBEEF)(ref this, id_array, fromTable); // .text:0042CD40 ; void __thiscall StringInfo::GetSubPrivateIDs(StringInfo *this, QualifiedDataIDArray *id_array, IDClass<_tagDataID,32,0> fromTable) .text:0042CD40 ?GetSubPrivateIDs@StringInfo@@QBEXAAVQualifiedDataIDArray@@V?$IDClass@U_tagDataID@@$0CA@$0A@@@@Z

        // StringInfo.InqString:
        // public Byte InqString(PStringBase<UInt16>* _result, Byte _bRetainMetas) => ((delegate* unmanaged[Thiscall]<ref StringInfo, PStringBase<UInt16>*, Byte, Byte>)0xDEADBEEF)(ref this, _result, _bRetainMetas); // .text:0042E490 ; bool __thiscall StringInfo::InqString(StringInfo *this, PStringBase<unsigned short> *_result, bool _bRetainMetas) .text:0042E490 ?InqString@StringInfo@@QBE_NAAV?$PStringBase@G@@_N@Z

        // StringInfo.InqStringInternal:
        // public GetStringErrorCode InqStringInternal(PStringBase<UInt16>* _result, Byte _bRetainMetas) => ((delegate* unmanaged[Thiscall]<ref StringInfo, PStringBase<UInt16>*, Byte, GetStringErrorCode>)0xDEADBEEF)(ref this, _result, _bRetainMetas); // .text:0042E020 ; GetStringErrorCode __thiscall StringInfo::InqStringInternal(StringInfo *this, PStringBase<unsigned short> *_result, bool _bRetainMetas) .text:0042E020 ?InqStringInternal@StringInfo@@IBE?AW4GetStringErrorCode@@AAV?$PStringBase@G@@_N@Z

        // StringInfo.InqStringTableFile:
        public Byte InqStringTableFile(PStringBase<char>* _strDataFile) => ((delegate* unmanaged[Thiscall]<ref StringInfo, PStringBase<char>*, Byte>)0x0042CA50)(ref this, _strDataFile); // .text:0042C7F0 ; bool __thiscall StringInfo::InqStringTableFile(StringInfo *this, PStringBase<char> *_strDataFile) .text:0042C7F0 ?InqStringTableFile@StringInfo@@QBE_NAAV?$PStringBase@D@@@Z

        // StringInfo.IsValid:
        public Byte IsValid(Byte bValidateChildren) => ((delegate* unmanaged[Thiscall]<ref StringInfo, Byte, Byte>)0x0042CE00)(ref this, bValidateChildren); // .text:0042CBE0 ; bool __thiscall StringInfo::IsValid(StringInfo *this, bool bValidateChildren) .text:0042CBE0 ?IsValid@StringInfo@@QBE_N_N@Z

        // StringInfo.Reset:
        public void Reset() => ((delegate* unmanaged[Thiscall]<ref StringInfo, void>)0x0042DD10)(ref this); // .text:0042DAF0 ; void __thiscall StringInfo::Reset(StringInfo *this) .text:0042DAF0 ?Reset@StringInfo@@QAEXXZ

        // StringInfo.Serialize:
        // public void Serialize(Archive* _rArchive) => ((delegate* unmanaged[Thiscall]<ref StringInfo, Archive*, void>)0xDEADBEEF)(ref this, _rArchive); // .text:0042DEB0 ; void __thiscall StringInfo::Serialize(StringInfo *this, Archive *_rArchive) .text:0042DEB0 ?Serialize@StringInfo@@QAEXAAVArchive@@@Z

        // StringInfo.SetLiteralValue:
        public void SetLiteralValue(PStringBase<UInt16>* _value, Byte _escape_metas) => ((delegate* unmanaged[Thiscall]<ref StringInfo, PStringBase<UInt16>*, Byte, void>)0x0042CBE0)(ref this, _value, _escape_metas); // .text:0042C980 ; void __thiscall StringInfo::SetLiteralValue(StringInfo *this, PStringBase<unsigned short> *_value, bool _escape_metas) .text:0042C980 ?SetLiteralValue@StringInfo@@QAEXABV?$PStringBase@G@@_N@Z

        // StringInfo.SetStringIDandTableEnum:
        public void SetStringIDandTableEnum(UInt32 _stringID, int _strtableEnum) => ((delegate* unmanaged[Thiscall]<ref StringInfo, UInt32, int, void>)0x0042C9C0)(ref this, _stringID, _strtableEnum); // .text:0042C760 ; void __thiscall StringInfo::SetStringIDandTableEnum(StringInfo *this, unsigned int _stringID, int _strtableEnum) .text:0042C760 ?SetStringIDandTableEnum@StringInfo@@QAEXKJ@Z

        // StringInfo.SetStringIDandTableID:
        public void SetStringIDandTableID(UInt32 _stringID, UInt32 _strtableID) => ((delegate* unmanaged[Thiscall]<ref StringInfo, UInt32, UInt32, void>)0x0042CA10)(ref this, _stringID, _strtableID); // .text:0042C7B0 ; void __thiscall StringInfo::SetStringIDandTableID(StringInfo *this, unsigned int _stringID, IDClass<_tagDataID,32,0> _strtableID) .text:0042C7B0 ?SetStringIDandTableID@StringInfo@@QAEXKV?$IDClass@U_tagDataID@@$0CA@$0A@@@@Z

        // StringInfo.SetTableEnum:
        public void SetTableEnum(int _strtableEnum) => ((delegate* unmanaged[Thiscall]<ref StringInfo, int, void>)0x0042C980)(ref this, _strtableEnum); // .text:0042C720 ; void __thiscall StringInfo::SetTableEnum(StringInfo *this, int _strtableEnum) .text:0042C720 ?SetTableEnum@StringInfo@@QAEXJ@Z
    }
    ...
    public unsafe struct UIElement_Text {
        ...
        public void AddText_Internal(PStringBase<UInt16> _text, UInt32 i_atfFlags) => ((delegate* unmanaged[Thiscall]<ref UIElement_Text, PStringBase<UInt16>, UInt32, void>)0x00469CC0)(ref this, _text, i_atfFlags); // .text:00469A30 ; void __thiscall UIElement_Text::AddText_Internal(UIElement_Text *this, PStringBase<unsigned short> _text, unsigned int i_atfFlags) .text:00469A30 ?AddText_Internal@UIElement_Text@@AAEXV?$PStringBase@G@@K@Z
        ...
        public void AppendStringInfo(StringInfo* _info) => ((delegate* unmanaged[Thiscall]<ref UIElement_Text, StringInfo*, void>)0x00469FA0)(ref this, _info); // .text:00469D10 ; void __thiscall UIElement_Text::AppendStringInfo(UIElement_Text *this, StringInfo *_info) .text:00469D10 ?AppendStringInfo@UIElement_Text@@QAEXABVStringInfo@@@Z
        ...
        public void AppendText(PStringBase<UInt16> _text) => ((delegate* unmanaged[Thiscall]<ref UIElement_Text, PStringBase<UInt16>, void>)0x00469F70)(ref this, _text); // .text:00469CE0 ; void __thiscall UIElement_Text::AppendText(UIElement_Text *this, PStringBase<unsigned short> *_text) .text:00469CE0 ?AppendText@UIElement_Text@@QAEXABV?$PStringBase@G@@@Z
        ...
        public void BeheadText(UInt32 i_cPosition, Byte bKeepCurrentTextInView) => ((delegate* unmanaged[Thiscall]<ref UIElement_Text, UInt32, Byte, void>)0x00469C00)(ref this, i_cPosition, bKeepCurrentTextInView); // .text:00469970 ; void __thiscall UIElement_Text::BeheadText(UIElement_Text *this, unsigned int i_cPosition, bool bKeepCurrentTextInView) .text:00469970 ?BeheadText@UIElement_Text@@QAEXK_N@Z

        // UIElement_Text.CalcJustification:
        public int CalcJustification(UInt32 i_uiTextSize, Byte i_bHorizontal) => ((delegate* unmanaged[Thiscall]<ref UIElement_Text, UInt32, Byte, int>)0x004674F0)(ref this, i_uiTextSize, i_bHorizontal); // .text:00467260 ; int __thiscall UIElement_Text::CalcJustification(UIElement_Text *this, unsigned int i_uiTextSize, bool i_bHorizontal) .text:00467260 ?CalcJustification@UIElement_Text@@QAEJK_N@Z

        // UIElement_Text.ChangeExistingTextToNewFont:
        public void ChangeExistingTextToNewFont(Font* i_pNewFont) => ((delegate* unmanaged[Thiscall]<ref UIElement_Text, Font*, void>)0x00467000)(ref this, i_pNewFont); // .text:00466D70 ; void __thiscall UIElement_Text::ChangeExistingTextToNewFont(UIElement_Text *this, Font *i_pNewFont) .text:00466D70 ?ChangeExistingTextToNewFont@UIElement_Text@@QAEXPAVFont@@@Z

        // UIElement_Text.CharacterHandler:
        public void CharacterHandler(ushort charToHandle) => ((delegate* unmanaged[Thiscall]<ref UIElement_Text, ushort, void>)0x00469E20)(ref this, charToHandle); // .text:00469B90 ; void __thiscall UIElement_Text::CharacterHandler(UIElement_Text *this, wchar_t charToHandle) .text:00469B90 ?CharacterHandler@UIElement_Text@@UAEXG@Z

        // UIElement_Text.CheckStringDownloads:
        public void CheckStringDownloads() => ((delegate* unmanaged[Thiscall]<ref UIElement_Text, void>)0x0046A100)(ref this); // .text:00469E70 ; void __thiscall UIElement_Text::CheckStringDownloads(UIElement_Text *this) .text:00469E70 ?CheckStringDownloads@UIElement_Text@@IAEXXZ

        // UIElement_Text.CleanupStringDownloads:
        public void CleanupStringDownloads() => ((delegate* unmanaged[Thiscall]<ref UIElement_Text, void>)0x004667D0)(ref this); // .text:004666A0 ; void __thiscall UIElement_Text::CleanupStringDownloads(UIElement_Text *this) .text:004666A0 ?CleanupStringDownloads@UIElement_Text@@IAEXXZ
        ...
        // UIElement_Text.Copy:
        public void Copy() => ((delegate* unmanaged[Thiscall]<ref UIElement_Text, void>)0x00468B30)(ref this); // .text:004688A0 ; void __thiscall UIElement_Text::Copy(UIElement_Text *this) .text:004688A0 ?Copy@UIElement_Text@@AAEXXZ

        // UIElement_Text.Create:
        public static UIElement* Create(LayoutDesc* _layout, ElementDesc* _full_desc) => ((delegate* unmanaged[Cdecl]<LayoutDesc*, ElementDesc*, UIElement*>)0x00468A20)(_layout, _full_desc); // .text:00468790 ; UIElement *__cdecl UIElement_Text::Create(LayoutDesc *_layout, ElementDesc *_full_desc) .text:00468790 ?Create@UIElement_Text@@SAPAVUIElement@@ABVLayoutDesc@@ABVElementDesc@@@Z

        // UIElement_Text.Cut:
        public void Cut() => ((delegate* unmanaged[Thiscall]<ref UIElement_Text, void>)0x00469DF0)(ref this); // .text:00469B60 ; void __thiscall UIElement_Text::Cut(UIElement_Text *this) .text:00469B60 ?Cut@UIElement_Text@@AAEXXZ

        // UIElement_Text.DeleteChar:
        public void DeleteChar() => ((delegate* unmanaged[Thiscall]<ref UIElement_Text, void>)0x00469C20)(ref this); // .text:00469990 ; void __thiscall UIElement_Text::DeleteChar(UIElement_Text *this) .text:00469990 ?DeleteChar@UIElement_Text@@IAEXXZ

        // UIElement_Text.DeleteSection:
        public void DeleteSection(UInt32 i_nStart, UInt32 i_nEnd, Byte i_bKeepCurrentTextInView) => ((delegate* unmanaged[Thiscall]<ref UIElement_Text, UInt32, UInt32, Byte, void>)0x00469A90)(ref this, i_nStart, i_nEnd, i_bKeepCurrentTextInView); // .text:00469800 ; void __thiscall UIElement_Text::DeleteSection(UIElement_Text *this, unsigned int i_nStart, unsigned int i_nEnd, bool i_bKeepCurrentTextInView) .text:00469800 ?DeleteSection@UIElement_Text@@IAEXKK_N@Z

        // UIElement_Text.DeleteSelection:
        public void DeleteSelection() => ((delegate* unmanaged[Thiscall]<ref UIElement_Text, void>)0x00469C40)(ref this); // .text:004699B0 ; void __thiscall UIElement_Text::DeleteSelection(UIElement_Text *this) .text:004699B0 ?DeleteSelection@UIElement_Text@@IAEXXZ
        ...
        public void DetermineMarginValues() => ((delegate* unmanaged[Thiscall]<ref UIElement_Text, void>)0x004669D0)(ref this); // .text:004668A0 ; void __thiscall UIElement_Text::DetermineMarginValues(UIElement_Text *this) .text:004668A0 ?DetermineMarginValues@UIElement_Text@@AAEXXZ

        // UIElement_Text.DeterminePositionFromXY:
        public UInt32 DeterminePositionFromXY(int i_x, int i_y) => ((delegate* unmanaged[Thiscall]<ref UIElement_Text, int, int, UInt32>)0x00468B80)(ref this, i_x, i_y); // .text:004688F0 ; unsigned int __thiscall UIElement_Text::DeterminePositionFromXY(UIElement_Text *this, int i_x, int i_y) .text:004688F0 ?DeterminePositionFromXY@UIElement_Text@@IAEKJJ@Z

        // UIElement_Text.DoFontReset:
        public void DoFontReset() => ((delegate* unmanaged[Thiscall]<ref UIElement_Text, void>)0x0046A7F0)(ref this); // .text:0046A560 ; void __thiscall UIElement_Text::DoFontReset(UIElement_Text *this) .text:0046A560 ?DoFontReset@UIElement_Text@@QAEXXZ
        ...
        public UIElement* DynamicCast(UInt32 i_eType) => ((delegate* unmanaged[Thiscall]<ref UIElement_Text, UInt32, UIElement*>)0x00467A70)(ref this, i_eType); // .text:004677E0 ; UIElement *__thiscall UIElement_Text::DynamicCast(UIElement_Text *this, unsigned int i_eType) .text:004677E0 ?DynamicCast@UIElement_Text@@UAEPAVUIElement@@K@Z
        ...
        public PStringBase<UInt16>* GetSelectedText(PStringBase<UInt16>* result) => ((delegate* unmanaged[Thiscall]<ref UIElement_Text, PStringBase<UInt16>*, PStringBase<UInt16>*>)0x00467C30)(ref this, result); // .text:004679A0 ; PStringBase<unsigned short> *__thiscall UIElement_Text::GetSelectedText(UIElement_Text *this, PStringBase<unsigned short> *result) .text:004679A0 ?GetSelectedText@UIElement_Text@@QBE?AV?$PStringBase@G@@XZ

        // UIElement_Text.GetSelection:
        public Byte GetSelection(UInt32* o_nStart, UInt32* o_nEnd) => ((delegate* unmanaged[Thiscall]<ref UIElement_Text, UInt32*, UInt32*, Byte>)0x004671B0)(ref this, o_nStart, o_nEnd); // .text:00466F20 ; bool __thiscall UIElement_Text::GetSelection(UIElement_Text *this, unsigned int *o_nStart, unsigned int *o_nEnd) .text:00466F20 ?GetSelection@UIElement_Text@@QBE_NAAK0@Z

        // UIElement_Text.GetShouldBeMouseVisible:
        public Byte GetShouldBeMouseVisible() => ((delegate* unmanaged[Thiscall]<ref UIElement_Text, Byte>)0x004676F0)(ref this); // .text:00467460 ; bool __thiscall UIElement_Text::GetShouldBeMouseVisible(UIElement_Text *this) .text:00467460 ?GetShouldBeMouseVisible@UIElement_Text@@MAE_NXZ
        ...
        public void Global_Loop() => ((delegate* unmanaged[Thiscall]<ref UIElement_Text, void>)0x0046A250)(ref this); // .text:00469FC0 ; void __thiscall UIElement_Text::Global_Loop(UIElement_Text *this) .text:00469FC0 ?Global_Loop@UIElement_Text@@IAEXXZ

        // UIElement_Text.IMETurnOn:
        public Byte IMETurnOn() => ((delegate* unmanaged[Thiscall]<ref UIElement_Text, Byte>)0x00466790)(ref this); // .text:00466660 ; bool __thiscall UIElement_Text::IMETurnOn(UIElement_Text *this) .text:00466660 ?IMETurnOn@UIElement_Text@@IAE_NXZ

        // UIElement_Text.InqAvailableProperties:
        public Byte InqAvailableProperties(AvailablePropertySet* _set) => ((delegate* unmanaged[Thiscall]<ref UIElement_Text, AvailablePropertySet*, Byte>)0x00467A90)(ref this, _set); // .text:00467800 ; bool __thiscall UIElement_Text::InqAvailableProperties(UIElement_Text *this, AvailablePropertySet *_set) .text:00467800 ?InqAvailableProperties@UIElement_Text@@UBE_NAAVAvailablePropertySet@@@Z

        // UIElement_Text.InqGlyphs:
        public Byte InqGlyphs(PStringBase<UInt16>* _text, SmartArray<Glyph>* _glyphs) => ((delegate* unmanaged[Thiscall]<ref UIElement_Text, PStringBase<UInt16>*, SmartArray<Glyph>*, Byte>)0x00469130)(ref this, _text, _glyphs); // .text:00468EA0 ; bool __thiscall UIElement_Text::InqGlyphs(UIElement_Text *this, PStringBase<unsigned short> *_text, SmartArray<Glyph,1> *_glyphs) .text:00468EA0 ?InqGlyphs@UIElement_Text@@IAE_NABV?$PStringBase@G@@AAV?$SmartArray@VGlyph@@$00@@@Z
        ...
        public Byte IsPositionInView(int* _nPos) => ((delegate* unmanaged[Thiscall]<ref UIElement_Text, int*, Byte>)0x00468D30)(ref this, _nPos); // .text:00468AA0 ; bool __thiscall UIElement_Text::IsPositionInView(UIElement_Text *this, const int *_nPos) .text:00468AA0 ?IsPositionInView@UIElement_Text@@QAE?B_NABJ@Z

        // UIElement_Text.ListenToElementMessage:
        public UIElementMessageListenResult ListenToElementMessage(UIElementMessageInfo* i_rMsg) => ((delegate* unmanaged[Thiscall]<ref UIElement_Text, UIElementMessageInfo*, UIElementMessageListenResult>)0x00468A50)(ref this, i_rMsg); // .text:004687C0 ; UIElementMessageListenResult __thiscall UIElement_Text::ListenToElementMessage(UIElement_Text *this, UIElementMessageInfo *i_rMsg) .text:004687C0 ?ListenToElementMessage@UIElement_Text@@UAE?AW4UIElementMessageListenResult@@ABUUIElementMessageInfo@@@Z
        ...
        public Byte MoveBeginEndLine(Byte i_bBegin, UInt32 i_nStart, UInt32* o_nPos) => ((delegate* unmanaged[Thiscall]<ref UIElement_Text, Byte, UInt32, UInt32*, Byte>)0x00467040)(ref this, i_bBegin, i_nStart, o_nPos); // .text:00466DB0 ; bool __thiscall UIElement_Text::MoveBeginEndLine(UIElement_Text *this, bool i_bBegin, unsigned int i_nStart, unsigned int *o_nPos) .text:00466DB0 ?MoveBeginEndLine@UIElement_Text@@IAE_N_NKAAK@Z

        // UIElement_Text.MoveCursor:
        //public Byte MoveCursor(TextDefs.Direction _dir) => ((delegate* unmanaged[Thiscall]<ref UIElement_Text, TextDefs.Direction, Byte>)0x00468F90)(ref this, _dir); // .text:00468D00 ; bool __thiscall UIElement_Text::MoveCursor(UIElement_Text *this, TextDefs::Direction _dir) .text:00468D00 ?MoveCursor@UIElement_Text@@IAE_NW4Direction@TextDefs@@@Z
        ...
        public void MoveCursorToPosition(int i_nPos) => ((delegate* unmanaged[Thiscall]<ref UIElement_Text, int, void>)0x00469120)(ref this, i_nPos); // .text:00468E90 ; void __thiscall UIElement_Text::MoveCursorToPosition(UIElement_Text *this, int i_nPos) .text:00468E90 ?MoveCursorToPosition@UIElement_Text@@QAEXJ@Z

        // UIElement_Text.MoveUpDown:
        public Byte MoveUpDown(Byte i_bUp, UInt32 i_nStart, UInt32* o_nPos) => ((delegate* unmanaged[Thiscall]<ref UIElement_Text, Byte, UInt32, UInt32*, Byte>)0x00468570)(ref this, i_bUp, i_nStart, o_nPos); // .text:004682E0 ; bool __thiscall UIElement_Text::MoveUpDown(UIElement_Text *this, bool i_bUp, unsigned int i_nStart, unsigned int *o_nPos) .text:004682E0 ?MoveUpDown@UIElement_Text@@IAE_N_NKAAK@Z
        ...
        public void Paste() => ((delegate* unmanaged[Thiscall]<ref UIElement_Text, void>)0x0046A3A0)(ref this); // .text:0046A110 ; void __thiscall UIElement_Text::Paste(UIElement_Text *this) .text:0046A110 ?Paste@UIElement_Text@@AAEXXZ

        // UIElement_Text.RecalculateGlyphList:
        public Byte RecalculateGlyphList() => ((delegate* unmanaged[Thiscall]<ref UIElement_Text, Byte>)0x004686B0)(ref this); // .text:00468420 ; bool __thiscall UIElement_Text::RecalculateGlyphList(UIElement_Text *this) .text:00468420 ?RecalculateGlyphList@UIElement_Text@@QAE_NXZ

        // UIElement_Text.RecalculateTruncation:
        public void RecalculateTruncation(int* io_iPaperWidth, int* io_iPaperHeight) => ((delegate* unmanaged[Thiscall]<ref UIElement_Text, int*, int*, void>)0x00467210)(ref this, io_iPaperWidth, io_iPaperHeight); // .text:00466F80 ; void __thiscall UIElement_Text::RecalculateTruncation(UIElement_Text *this, int *io_iPaperWidth, int *io_iPaperHeight) .text:00466F80 ?RecalculateTruncation@UIElement_Text@@QAEXAAJ0@Z

        // UIElement_Text.Register:
        public static void Register() => ((delegate* unmanaged[Cdecl]<void>)0x00468D20)(); // .text:00468A90 ; void __cdecl UIElement_Text::Register() .text:00468A90 ?Register@UIElement_Text@@SAXXZ
        ...
        public void ResizeToPaper() => ((delegate* unmanaged[Thiscall]<ref UIElement_Text, void>)0x004677E0)(ref this); // .text:00467550 ; void __thiscall UIElement_Text::ResizeToPaper(UIElement_Text *this) .text:00467550 ?ResizeToPaper@UIElement_Text@@IAEXXZ
        ...
        public void SetDirty(Byte _b) => ((delegate* unmanaged[Thiscall]<ref UIElement_Text, Byte, void>)0x00466980)(ref this, _b); // .text:00466850 ; void __thiscall UIElement_Text::SetDirty(UIElement_Text *this, bool _b) .text:00466850 ?SetDirty@UIElement_Text@@IAEX_N@Z

        // UIElement_Text.SetEditable:
        public void SetEditable(Byte _editable) => ((delegate* unmanaged[Thiscall]<ref UIElement_Text, Byte, void>)0x00468360)(ref this, _editable); // .text:004680D0 ; void __thiscall UIElement_Text::SetEditable(UIElement_Text *this, bool _editable) .text:004680D0 ?SetEditable@UIElement_Text@@IAEX_N@Z

        // UIElement_Text.SetFitToText:
        public void SetFitToText(Byte _b) => ((delegate* unmanaged[Thiscall]<ref UIElement_Text, Byte, void>)0x004687D0)(ref this, _b); // .text:00468540 ; void __thiscall UIElement_Text::SetFitToText(UIElement_Text *this, bool _b) .text:00468540 ?SetFitToText@UIElement_Text@@IAEX_N@Z

        // UIElement_Text.SetFontColorHelper:
        public void SetFontColorHelper(UInt32 _property, RGBAColor* _color, UInt32 _fontColorNum) => ((delegate* unmanaged[Thiscall]<ref UIElement_Text, UInt32, RGBAColor*, UInt32, void>)0x00466BF0)(ref this, _property, _color, _fontColorNum); // .text:00466AC0 ; void __thiscall UIElement_Text::SetFontColorHelper(UIElement_Text *this, unsigned int _property, RGBAColor *_color, unsigned int _fontColorNum) .text:00466AC0 ?SetFontColorHelper@UIElement_Text@@IAEXKAAVRGBAColor@@K@Z

        // UIElement_Text.SetFontColorNum:
        public void SetFontColorNum(UInt32 _fontColorNum) => ((delegate* unmanaged[Thiscall]<ref UIElement_Text, UInt32, void>)0x00468540)(ref this, _fontColorNum); // .text:004682B0 ; void __thiscall UIElement_Text::SetFontColorNum(UIElement_Text *this, unsigned int _fontColorNum) .text:004682B0 ?SetFontColorNum@UIElement_Text@@QAEXK@Z

        // UIElement_Text.SetFontDID:
        public void SetFontDID(UInt32 _did) => ((delegate* unmanaged[Thiscall]<ref UIElement_Text, UInt32, void>)0x00466E80)(ref this, _did); // .text:00466BF0 ; void __thiscall UIElement_Text::SetFontDID(UIElement_Text *this, IDClass<_tagDataID,32,0> _did) .text:00466BF0 ?SetFontDID@UIElement_Text@@QAEXV?$IDClass@U_tagDataID@@$0CA@$0A@@@@Z

        // UIElement_Text.SetFontDIDHelper:
        public void SetFontDIDHelper(UInt32 _property, Font** _font, UInt32 _fontDIDNum) => ((delegate* unmanaged[Thiscall]<ref UIElement_Text, UInt32, Font**, UInt32, void>)0x00466A90)(ref this, _property, _font, _fontDIDNum); // .text:00466960 ; void __thiscall UIElement_Text::SetFontDIDHelper(UIElement_Text *this, unsigned int _property, Font **_font, unsigned int _fontDIDNum) .text:00466960 ?SetFontDIDHelper@UIElement_Text@@IAEXKAAPAVFont@@K@Z

        // UIElement_Text.SetFontDIDNum:
        public void SetFontDIDNum(UInt32 _fontDIDNum) => ((delegate* unmanaged[Thiscall]<ref UIElement_Text, UInt32, void>)0x00468520)(ref this, _fontDIDNum); // .text:00468290 ; void __thiscall UIElement_Text::SetFontDIDNum(UIElement_Text *this, unsigned int _fontDIDNum) .text:00468290 ?SetFontDIDNum@UIElement_Text@@QAEXK@Z

        // UIElement_Text.SetFontDIDWithoutChangingExistingText:
        public void SetFontDIDWithoutChangingExistingText(UInt32 _did) => ((delegate* unmanaged[Thiscall]<ref UIElement_Text, UInt32, void>)0x00466FE0)(ref this, _did); // .text:00466D50 ; void __thiscall UIElement_Text::SetFontDIDWithoutChangingExistingText(UIElement_Text *this, IDClass<_tagDataID,32,0> _did) .text:00466D50 ?SetFontDIDWithoutChangingExistingText@UIElement_Text@@QAEXV?$IDClass@U_tagDataID@@$0CA@$0A@@@@Z

        // UIElement_Text.SetHorizontalJustification:
        public Byte SetHorizontalJustification(UInt32 i_eJustification) => ((delegate* unmanaged[Thiscall]<ref UIElement_Text, UInt32, Byte>)0x00467490)(ref this, i_eJustification); // .text:00467200 ; bool __thiscall UIElement_Text::SetHorizontalJustification(UIElement_Text *this, unsigned int i_eJustification) .text:00467200 ?SetHorizontalJustification@UIElement_Text@@QAE?B_NK@Z

        // UIElement_Text.SetLoseFocusOnAcceptInput:
        public void SetLoseFocusOnAcceptInput(Byte _b) => ((delegate* unmanaged[Thiscall]<ref UIElement_Text, Byte, void>)0x004677B0)(ref this, _b); // .text:00467520 ; void __thiscall UIElement_Text::SetLoseFocusOnAcceptInput(UIElement_Text *this, bool _b) .text:00467520 ?SetLoseFocusOnAcceptInput@UIElement_Text@@IAEX_N@Z

        // UIElement_Text.SetLoseFocusOnEscape:
        public void SetLoseFocusOnEscape(Byte _b) => ((delegate* unmanaged[Thiscall]<ref UIElement_Text, Byte, void>)0x00467780)(ref this, _b); // .text:004674F0 ; void __thiscall UIElement_Text::SetLoseFocusOnEscape(UIElement_Text *this, bool _b) .text:004674F0 ?SetLoseFocusOnEscape@UIElement_Text@@IAEX_N@Z

        // UIElement_Text.SetNoIme:
        public void SetNoIme(Byte _b) => ((delegate* unmanaged[Thiscall]<ref UIElement_Text, Byte, void>)0x00466730)(ref this, _b); // .text:00466600 ; void __thiscall UIElement_Text::SetNoIme(UIElement_Text *this, bool _b) .text:00466600 ?SetNoIme@UIElement_Text@@IAEX_N@Z

        // UIElement_Text.SetOneLine:
        public void SetOneLine(Byte _b) => ((delegate* unmanaged[Thiscall]<ref UIElement_Text, Byte, void>)0x00468400)(ref this, _b); // .text:00468170 ; void __thiscall UIElement_Text::SetOneLine(UIElement_Text *this, bool _b) .text:00468170 ?SetOneLine@UIElement_Text@@IAEX_N@Z

        // UIElement_Text.SetOutline:
        public void SetOutline(Byte _b) => ((delegate* unmanaged[Thiscall]<ref UIElement_Text, Byte, void>)0x00466760)(ref this, _b); // .text:00466630 ; void __thiscall UIElement_Text::SetOutline(UIElement_Text *this, bool _b) .text:00466630 ?SetOutline@UIElement_Text@@IAEX_N@Z

        // UIElement_Text.SetSelectable:
        public void SetSelectable(Byte _b) => ((delegate* unmanaged[Thiscall]<ref UIElement_Text, Byte, void>)0x00468450)(ref this, _b); // .text:004681C0 ; void __thiscall UIElement_Text::SetSelectable(UIElement_Text *this, bool _b) .text:004681C0 ?SetSelectable@UIElement_Text@@IAEX_N@Z
        ...
        public Byte SetSelectionEnd(UInt32 i_nPos) => ((delegate* unmanaged[Thiscall]<ref UIElement_Text, UInt32, Byte>)0x00467150)(ref this, i_nPos); // .text:00466EC0 ; bool __thiscall UIElement_Text::SetSelectionEnd(UIElement_Text *this, unsigned int i_nPos) .text:00466EC0 ?SetSelectionEnd@UIElement_Text@@QAE_NK@Z

        // UIElement_Text.SetSelectionStart:
        public Byte SetSelectionStart(UInt32 i_nPos) => ((delegate* unmanaged[Thiscall]<ref UIElement_Text, UInt32, Byte>)0x004670F0)(ref this, i_nPos); // .text:00466E60 ; bool __thiscall UIElement_Text::SetSelectionStart(UIElement_Text *this, unsigned int i_nPos) .text:00466E60 ?SetSelectionStart@UIElement_Text@@QAE_NK@Z
        ...
        public void SetTruncateTextToFit(Byte _b) => ((delegate* unmanaged[Thiscall]<ref UIElement_Text, Byte, void>)0x00467710)(ref this, _b); // .text:00467480 ; void __thiscall UIElement_Text::SetTruncateTextToFit(UIElement_Text *this, bool _b) .text:00467480 ?SetTruncateTextToFit@UIElement_Text@@IAEX_N@Z

        // UIElement_Text.SetVerticalJustification:
        public Byte SetVerticalJustification(UInt32 i_eJustification) => ((delegate* unmanaged[Thiscall]<ref UIElement_Text, UInt32, Byte>)0x004674C0)(ref this, i_eJustification); // .text:00467230 ; bool __thiscall UIElement_Text::SetVerticalJustification(UIElement_Text *this, unsigned int i_eJustification) .text:00467230 ?SetVerticalJustification@UIElement_Text@@QAE?B_NK@Z
    ...
    public unsafe struct UIElementManager {
        ...
        public UIElement* GetElement(UInt32 _ID) => ((delegate* unmanaged[Thiscall]<ref UIElementManager, UInt32, UIElement*>)0x00459A00)(ref this, _ID); // .text:00459990 ; UIElement *__thiscall UIElementManager::GetElement(UIElementManager *this, unsigned int _ID) .text:00459990 ?GetElement@UIElementManager@@QAEPAVUIElement@@K@Z
