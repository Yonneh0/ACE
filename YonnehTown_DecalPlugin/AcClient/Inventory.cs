...
namespace AcClient {
    ...
    public unsafe struct gmToolbarUI {
        ...
        // gmToolbarUI.__Ctor:
        // public void __Ctor(LayoutDesc* _layout, ElementDesc* _full_desc) => ((delegate* unmanaged[Thiscall]<ref gmToolbarUI, LayoutDesc*, ElementDesc*, void>)0xDEADBEEF)(ref this, _layout, _full_desc); // .text:004BD710 ; void __thiscall gmToolbarUI::gmToolbarUI(gmToolbarUI *this, LayoutDesc *_layout, ElementDesc *_full_desc) .text:004BD710 ??0gmToolbarUI@@QAE@ABVLayoutDesc@@ABVElementDesc@@@Z

        // gmToolbarUI.AddShortcut:
        // public void AddShortcut(UInt32 _itemID, int _slot, Byte _broadcast) => ((delegate* unmanaged[Thiscall]<ref gmToolbarUI, UInt32, int, Byte, void>)0xDEADBEEF)(ref this, _itemID, _slot, _broadcast); // .text:004BD9A0 ; void __thiscall gmToolbarUI::AddShortcut(gmToolbarUI *this, unsigned int _itemID, int _slot, bool _broadcast) .text:004BD9A0 ?AddShortcut@gmToolbarUI@@IAEXKH_N@Z

        // gmToolbarUI.Create:
        // public static UIElement* Create(LayoutDesc* _layout, ElementDesc* _full_desc) => ((delegate* unmanaged[Cdecl]<LayoutDesc*, ElementDesc*, UIElement*>)0xDEADBEEF)(_layout, _full_desc); // .text:004BD8C0 ; UIElement *__cdecl gmToolbarUI::Create(LayoutDesc *_layout, ElementDesc *_full_desc) .text:004BD8C0 ?Create@gmToolbarUI@@SAPAVUIElement@@ABVLayoutDesc@@ABVElementDesc@@@Z

        // gmToolbarUI.CreateShortcutToItem:
        // public void CreateShortcutToItem(UInt32 _itemID, int _shortcutIndex, Byte _pickUp, Byte _silent) => ((delegate* unmanaged[Thiscall]<ref gmToolbarUI, UInt32, int, Byte, Byte, void>)0xDEADBEEF)(ref this, _itemID, _shortcutIndex, _pickUp, _silent); // .text:004BDAC0 ; void __thiscall gmToolbarUI::CreateShortcutToItem(gmToolbarUI *this, unsigned int _itemID, int _shortcutIndex, bool _pickUp, bool _silent) .text:004BDAC0 ?CreateShortcutToItem@gmToolbarUI@@IAEXKH_N0@Z

        // gmToolbarUI.DynamicCast:
        // public UIElement* DynamicCast(UInt32 i_eType) => ((delegate* unmanaged[Thiscall]<ref gmToolbarUI, UInt32, UIElement*>)0xDEADBEEF)(ref this, i_eType); // .text:004BD7D0 ; UIElement *__thiscall gmToolbarUI::DynamicCast(gmToolbarUI *this, unsigned int i_eType) .text:004BD7D0 ?DynamicCast@gmToolbarUI@@UAEPAVUIElement@@K@Z

        // gmToolbarUI.FlushShortcuts:
        // public void FlushShortcuts() => ((delegate* unmanaged[Thiscall]<ref gmToolbarUI, void>)0xDEADBEEF)(ref this); // .text:004BD420 ; void __thiscall gmToolbarUI::FlushShortcuts(gmToolbarUI *this) .text:004BD420 ?FlushShortcuts@gmToolbarUI@@IAEXXZ

        // gmToolbarUI.GetFirstEmptyShortcutToTheRightOf:
        // public int GetFirstEmptyShortcutToTheRightOf(UInt32 index) => ((delegate* unmanaged[Thiscall]<ref gmToolbarUI, UInt32, int>)0xDEADBEEF)(ref this, index); // .text:004BD560 ; int __thiscall gmToolbarUI::GetFirstEmptyShortcutToTheRightOf(gmToolbarUI *this, unsigned int index) .text:004BD560 ?GetFirstEmptyShortcutToTheRightOf@gmToolbarUI@@IAEHK@Z

        // gmToolbarUI.GetUIElementType:
        // public UInt32 GetUIElementType() => ((delegate* unmanaged[Thiscall]<ref gmToolbarUI, UInt32>)0xDEADBEEF)(ref this); // .text:004BD7F0 ; unsigned int __thiscall gmToolbarUI::GetUIElementType(gmToolbarUI *this) .text:004BD7F0 ?GetUIElementType@gmToolbarUI@@UBEKXZ

        // gmToolbarUI.HandleDropRelease:
        // public void HandleDropRelease(UIElementMessageInfo* i_rMsg) => ((delegate* unmanaged[Thiscall]<ref gmToolbarUI, UIElementMessageInfo*, void>)0xDEADBEEF)(ref this, i_rMsg); // .text:004BE7C0 ; void __thiscall gmToolbarUI::HandleDropRelease(gmToolbarUI *this, UIElementMessageInfo *i_rMsg) .text:004BE7C0 ?HandleDropRelease@gmToolbarUI@@IAEXABUUIElementMessageInfo@@@Z

        // gmToolbarUI.HandleInventoryButtonDragOver:
        // public void HandleInventoryButtonDragOver(UIElement* _dragElement) => ((delegate* unmanaged[Thiscall]<ref gmToolbarUI, UIElement*, void>)0xDEADBEEF)(ref this, _dragElement); // .text:004BD180 ; void __thiscall gmToolbarUI::HandleInventoryButtonDragOver(gmToolbarUI *this, UIElement *_dragElement) .text:004BD180 ?HandleInventoryButtonDragOver@gmToolbarUI@@IAEXPAVUIElement@@@Z

        // gmToolbarUI.HandleSelectionChanged:
        // public void HandleSelectionChanged() => ((delegate* unmanaged[Thiscall]<ref gmToolbarUI, void>)0xDEADBEEF)(ref this); // .text:004BF380 ; void __thiscall gmToolbarUI::HandleSelectionChanged(gmToolbarUI *this) .text:004BF380 ?HandleSelectionChanged@gmToolbarUI@@IAEXXZ

        // gmToolbarUI.InitShortcutArray:
        // public void InitShortcutArray() => ((delegate* unmanaged[Thiscall]<ref gmToolbarUI, void>)0xDEADBEEF)(ref this); // .text:004BDD50 ; void __thiscall gmToolbarUI::InitShortcutArray(gmToolbarUI *this) .text:004BDD50 ?InitShortcutArray@gmToolbarUI@@IAEXXZ

        // gmToolbarUI.IsShortcutEligible:
        // public Byte IsShortcutEligible(ACCWeenieObject* _weenObj) => ((delegate* unmanaged[Thiscall]<ref gmToolbarUI, ACCWeenieObject*, Byte>)0xDEADBEEF)(ref this, _weenObj); // .text:004BD1D0 ; bool __thiscall gmToolbarUI::IsShortcutEligible(gmToolbarUI *this, ACCWeenieObject *_weenObj) .text:004BD1D0 ?IsShortcutEligible@gmToolbarUI@@IAE_NPAVACCWeenieObject@@@Z

        // gmToolbarUI.IsShortcutSlotAvailable:
        // public Byte IsShortcutSlotAvailable(int _slot) => ((delegate* unmanaged[Thiscall]<ref gmToolbarUI, int, Byte>)0xDEADBEEF)(ref this, _slot); // .text:004BD5E0 ; bool __thiscall gmToolbarUI::IsShortcutSlotAvailable(gmToolbarUI *this, int _slot) .text:004BD5E0 ?IsShortcutSlotAvailable@gmToolbarUI@@IAE_NH@Z

        // gmToolbarUI.ListenToElementMessage:
        // public UIElementMessageListenResult ListenToElementMessage(UIElementMessageInfo* i_rMsg) => ((delegate* unmanaged[Thiscall]<ref gmToolbarUI, UIElementMessageInfo*, UIElementMessageListenResult>)0xDEADBEEF)(ref this, i_rMsg); // .text:004BEE90 ; UIElementMessageListenResult __thiscall gmToolbarUI::ListenToElementMessage(gmToolbarUI *this, UIElementMessageInfo *i_rMsg) .text:004BEE90 ?ListenToElementMessage@gmToolbarUI@@UAE?AW4UIElementMessageListenResult@@ABUUIElementMessageInfo@@@Z

        // gmToolbarUI.ListenToGlobalMessage:
        // public void ListenToGlobalMessage(UInt32 i_messageID, int i_data_int) => ((delegate* unmanaged[Thiscall]<ref gmToolbarUI, UInt32, int, void>)0xDEADBEEF)(ref this, i_messageID, i_data_int); // .text:004BE4E0 ; void __thiscall gmToolbarUI::ListenToGlobalMessage(gmToolbarUI *this, unsigned int i_messageID, int i_data_int) .text:004BE4E0 ?ListenToGlobalMessage@gmToolbarUI@@UAEXKJ@Z

        // gmToolbarUI.OnItemListDragOver:
        // public Byte OnItemListDragOver(UIElement_UIItem* _catchElement, UInt32 _dropItemID, UInt32 _dropSpellID, DropItemFlags _dropFlags) => ((delegate* unmanaged[Thiscall]<ref gmToolbarUI, UIElement_UIItem*, UInt32, UInt32, DropItemFlags, Byte>)0xDEADBEEF)(ref this, _catchElement, _dropItemID, _dropSpellID, _dropFlags); // .text:004BD150 ; bool __thiscall gmToolbarUI::OnItemListDragOver(gmToolbarUI *this, UIElement_UIItem *_catchElement, unsigned int _dropItemID, unsigned int _dropSpellID, DropItemFlags _dropFlags) .text:004BD150 ?OnItemListDragOver@gmToolbarUI@@MAE_NPAVUIElement_UIItem@@KKW4DropItemFlags@@@Z

        // gmToolbarUI.PostInit:
        // public void PostInit() => ((delegate* unmanaged[Thiscall]<ref gmToolbarUI, void>)0xDEADBEEF)(ref this); // .text:004BEA80 ; void __thiscall gmToolbarUI::PostInit(gmToolbarUI *this) .text:004BEA80 ?PostInit@gmToolbarUI@@UAEXXZ

        // gmToolbarUI.RecvNotice_AddShortcut:
        // public void RecvNotice_AddShortcut(UInt32 i_itemID, int i_slot) => ((delegate* unmanaged[Thiscall]<ref gmToolbarUI, UInt32, int, void>)0xDEADBEEF)(ref this, i_itemID, i_slot); // .text:004BE990 ; void __thiscall gmToolbarUI::RecvNotice_AddShortcut(gmToolbarUI *this, unsigned int i_itemID, int i_slot) .text:004BE990 ?RecvNotice_AddShortcut@gmToolbarUI@@MAEXKJ@Z

        // gmToolbarUI.RecvNotice_FullMergingItem:
        // public void RecvNotice_FullMergingItem(UInt32 i_oldObject, UInt32 i_mergeTo) => ((delegate* unmanaged[Thiscall]<ref gmToolbarUI, UInt32, UInt32, void>)0xDEADBEEF)(ref this, i_oldObject, i_mergeTo); // .text:004BE9B0 ; void __thiscall gmToolbarUI::RecvNotice_FullMergingItem(gmToolbarUI *this, unsigned int i_oldObject, unsigned int i_mergeTo) .text:004BE9B0 ?RecvNotice_FullMergingItem@gmToolbarUI@@MAEXKK@Z

        // gmToolbarUI.RecvNotice_ItemAttributesChanged:
        // public void RecvNotice_ItemAttributesChanged(UInt32 i_target, UInt32 i_attrib) => ((delegate* unmanaged[Thiscall]<ref gmToolbarUI, UInt32, UInt32, void>)0xDEADBEEF)(ref this, i_target, i_attrib); // .text:004BF8F0 ; void __thiscall gmToolbarUI::RecvNotice_ItemAttributesChanged(gmToolbarUI *this, unsigned int i_target, unsigned int i_attrib) .text:004BF8F0 ?RecvNotice_ItemAttributesChanged@gmToolbarUI@@MAEXKK@Z

        // gmToolbarUI.RecvNotice_ItemListBeginDrag:
        // public void RecvNotice_ItemListBeginDrag(UIElement* i_itemList, int i_slotNum) => ((delegate* unmanaged[Thiscall]<ref gmToolbarUI, UIElement*, int, void>)0xDEADBEEF)(ref this, i_itemList, i_slotNum); // .text:004BD930 ; void __thiscall gmToolbarUI::RecvNotice_ItemListBeginDrag(gmToolbarUI *this, UIElement *i_itemList, int i_slotNum) .text:004BD930 ?RecvNotice_ItemListBeginDrag@gmToolbarUI@@MAEXABVUIElement@@J@Z

        // gmToolbarUI.RecvNotice_PlayerDescReceived:
        // public void RecvNotice_PlayerDescReceived(CACQualities* i_playerDesc, CPlayerModule* i_playerModule) => ((delegate* unmanaged[Thiscall]<ref gmToolbarUI, CACQualities*, CPlayerModule*, void>)0xDEADBEEF)(ref this, i_playerDesc, i_playerModule); // .text:004BF980 ; void __thiscall gmToolbarUI::RecvNotice_PlayerDescReceived(gmToolbarUI *this, CACQualities *i_playerDesc, CPlayerModule *i_playerModule) .text:004BF980 ?RecvNotice_PlayerDescReceived@gmToolbarUI@@MAEXABVCACQualities@@ABVCPlayerModule@@@Z

        // gmToolbarUI.RecvNotice_RemoveShortcut:
        // public void RecvNotice_RemoveShortcut(UInt32 i_itemID) => ((delegate* unmanaged[Thiscall]<ref gmToolbarUI, UInt32, void>)0xDEADBEEF)(ref this, i_itemID); // .text:004BD8F0 ; void __thiscall gmToolbarUI::RecvNotice_RemoveShortcut(gmToolbarUI *this, unsigned int i_itemID) .text:004BD8F0 ?RecvNotice_RemoveShortcut@gmToolbarUI@@MAEXK@Z

        // gmToolbarUI.RecvNotice_SelectionChanged:
        // public void RecvNotice_SelectionChanged() => ((delegate* unmanaged[Thiscall]<ref gmToolbarUI, void>)0xDEADBEEF)(ref this); // .text:004BF970 ; void __thiscall gmToolbarUI::RecvNotice_SelectionChanged(gmToolbarUI *this) .text:004BF970 ?RecvNotice_SelectionChanged@gmToolbarUI@@MAEXXZ

        // gmToolbarUI.RecvNotice_ServerSaysMoveItem:
        // public void RecvNotice_ServerSaysMoveItem(UInt32 _itemID, UInt32 _oldContainer, UInt32 _oldWielder, UInt32 _oldLocation, UInt32 _newContainer, int _place, UInt32 _newWielder, UInt32 _newLocation) => ((delegate* unmanaged[Thiscall]<ref gmToolbarUI, UInt32, UInt32, UInt32, UInt32, UInt32, int, UInt32, UInt32, void>)0xDEADBEEF)(ref this, _itemID, _oldContainer, _oldWielder, _oldLocation, _newContainer, _place, _newWielder, _newLocation); // .text:004BF2B0 ; void __thiscall gmToolbarUI::RecvNotice_ServerSaysMoveItem(gmToolbarUI *this, unsigned int _itemID, unsigned int _oldContainer, unsigned int _oldWielder, unsigned int _oldLocation, unsigned int _newContainer, int _place, unsigned int _newWielder, unsigned int _newLocation) .text:004BF2B0 ?RecvNotice_ServerSaysMoveItem@gmToolbarUI@@MAEXKKKKKHKK@Z

        // gmToolbarUI.RecvNotice_SetCombatMode:
        // public void RecvNotice_SetCombatMode(COMBAT_MODE i_eCombatMode) => ((delegate* unmanaged[Thiscall]<ref gmToolbarUI, COMBAT_MODE, void>)0xDEADBEEF)(ref this, i_eCombatMode); // .text:004BD610 ; void __thiscall gmToolbarUI::RecvNotice_SetCombatMode(gmToolbarUI *this, COMBAT_MODE i_eCombatMode) .text:004BD610 ?RecvNotice_SetCombatMode@gmToolbarUI@@MAEXW4COMBAT_MODE@@@Z

        // gmToolbarUI.RecvNotice_SetPanelVisibility:
        // public void RecvNotice_SetPanelVisibility(UInt32 i_ePanelID, Byte i_bVisible) => ((delegate* unmanaged[Thiscall]<ref gmToolbarUI, UInt32, Byte, void>)0xDEADBEEF)(ref this, i_ePanelID, i_bVisible); // .text:004BD300 ; void __thiscall gmToolbarUI::RecvNotice_SetPanelVisibility(gmToolbarUI *this, unsigned int i_ePanelID, bool i_bVisible) .text:004BD300 ?RecvNotice_SetPanelVisibility@gmToolbarUI@@MAEXK_N@Z

        // gmToolbarUI.RecvNotice_SplitStack:
        // public void RecvNotice_SplitStack(UInt32 i_iidItem) => ((delegate* unmanaged[Thiscall]<ref gmToolbarUI, UInt32, void>)0xDEADBEEF)(ref this, i_iidItem); // .text:004BD2A0 ; void __thiscall gmToolbarUI::RecvNotice_SplitStack(gmToolbarUI *this, unsigned int i_iidItem) .text:004BD2A0 ?RecvNotice_SplitStack@gmToolbarUI@@MAEXK@Z

        // gmToolbarUI.RecvNotice_UpdateItemMana:
        // public void RecvNotice_UpdateItemMana(UInt32 i_iidTarget, Single i_fMana, Byte i_bSuccess) => ((delegate* unmanaged[Thiscall]<ref gmToolbarUI, UInt32, Single, Byte, void>)0xDEADBEEF)(ref this, i_iidTarget, i_fMana, i_bSuccess); // .text:004BD0C0 ; void __thiscall gmToolbarUI::RecvNotice_UpdateItemMana(gmToolbarUI *this, unsigned int i_iidTarget, float i_fMana, bool i_bSuccess) .text:004BD0C0 ?RecvNotice_UpdateItemMana@gmToolbarUI@@MAEXKM_N@Z

        // gmToolbarUI.RecvNotice_UpdateObjectHealth:
        // public void RecvNotice_UpdateObjectHealth(UInt32 i_iidTarget, Single i_fHealth) => ((delegate* unmanaged[Thiscall]<ref gmToolbarUI, UInt32, Single, void>)0xDEADBEEF)(ref this, i_iidTarget, i_fHealth); // .text:004BD110 ; void __thiscall gmToolbarUI::RecvNotice_UpdateObjectHealth(gmToolbarUI *this, unsigned int i_iidTarget, float i_fHealth) .text:004BD110 ?RecvNotice_UpdateObjectHealth@gmToolbarUI@@MAEXKM@Z

        // gmToolbarUI.RecvNotice_UseShortcut:
        // public void RecvNotice_UseShortcut(int i_slot) => ((delegate* unmanaged[Thiscall]<ref gmToolbarUI, int, void>)0xDEADBEEF)(ref this, i_slot); // .text:004BD910 ; void __thiscall gmToolbarUI::RecvNotice_UseShortcut(gmToolbarUI *this, int i_slot) .text:004BD910 ?RecvNotice_UseShortcut@gmToolbarUI@@MAEXJ@Z
        ...
        // public int RemoveShortcut(UInt32 _itemID, Byte _broadcast) => ((delegate* unmanaged[Thiscall]<ref gmToolbarUI, UInt32, Byte, int>)0xDEADBEEF)(ref this, _itemID, _broadcast); // .text:004BD450 ; int __thiscall gmToolbarUI::RemoveShortcut(gmToolbarUI *this, unsigned int _itemID, bool _broadcast) .text:004BD450 ?RemoveShortcut@gmToolbarUI@@IAEHK_N@Z

        // gmToolbarUI.RemoveShortcutInSlotNum:
        // public UInt32 RemoveShortcutInSlotNum(int _slot, Byte _broadcast) => ((delegate* unmanaged[Thiscall]<ref gmToolbarUI, int, Byte, UInt32>)0xDEADBEEF)(ref this, _slot, _broadcast); // .text:004BD4F0 ; unsigned int __thiscall gmToolbarUI::RemoveShortcutInSlotNum(gmToolbarUI *this, int _slot, bool _broadcast) .text:004BD4F0 ?RemoveShortcutInSlotNum@gmToolbarUI@@IAEKH_N@Z

        // gmToolbarUI.UpdateAmmoID:
        // public void UpdateAmmoID() => ((delegate* unmanaged[Thiscall]<ref gmToolbarUI, void>)0xDEADBEEF)(ref this); // .text:004BF210 ; void __thiscall gmToolbarUI::UpdateAmmoID(gmToolbarUI *this) .text:004BF210 ?UpdateAmmoID@gmToolbarUI@@IAEXXZ

        // gmToolbarUI.UpdateAmmoNumber:
        // public void UpdateAmmoNumber() => ((delegate* unmanaged[Thiscall]<ref gmToolbarUI, void>)0xDEADBEEF)(ref this); // .text:004BE9E0 ; void __thiscall gmToolbarUI::UpdateAmmoNumber(gmToolbarUI *this) .text:004BE9E0 ?UpdateAmmoNumber@gmToolbarUI@@IAEXXZ

        // gmToolbarUI.UpdateFromPlayerDesc:
        // public void UpdateFromPlayerDesc() => ((delegate* unmanaged[Thiscall]<ref gmToolbarUI, void>)0xDEADBEEF)(ref this); // .text:004BF810 ; void __thiscall gmToolbarUI::UpdateFromPlayerDesc(gmToolbarUI *this) .text:004BF810 ?UpdateFromPlayerDesc@gmToolbarUI@@IAEXXZ

        // gmToolbarUI.UseShortcut:
        // public void UseShortcut(int _slot, Byte i_bUse) => ((delegate* unmanaged[Thiscall]<ref gmToolbarUI, int, Byte, void>)0xDEADBEEF)(ref this, _slot, i_bUse); // .text:004BD350 ; void __thiscall gmToolbarUI::UseShortcut(gmToolbarUI *this, int _slot, bool i_bUse) .text:004BD350 ?UseShortcut@gmToolbarUI@@IAEXH_N@Z
    }
    ...
    public unsafe struct gm3DItemsUI {
        ...
        // gm3DItemsUI.Create:
        // public static UIElement* Create(LayoutDesc* _layout, ElementDesc* _full_desc) => ((delegate* unmanaged[Cdecl]<LayoutDesc*, ElementDesc*, UIElement*>)0xDEADBEEF)(_layout, _full_desc); // .text:004A70D0 ; UIElement *__cdecl gm3DItemsUI::Create(LayoutDesc *_layout, ElementDesc *_full_desc) .text:004A70D0 ?Create@gm3DItemsUI@@SAPAVUIElement@@ABVLayoutDesc@@ABVElementDesc@@@Z

        // gm3DItemsUI.DynamicCast:
        // public UIElement* DynamicCast(UInt32 i_eType) => ((delegate* unmanaged[Thiscall]<ref gm3DItemsUI, UInt32, UIElement*>)0xDEADBEEF)(ref this, i_eType); // .text:004A70A0 ; UIElement *__thiscall gm3DItemsUI::DynamicCast(gm3DItemsUI *this, unsigned int i_eType) .text:004A70A0 ?DynamicCast@gm3DItemsUI@@UAEPAVUIElement@@K@Z

        // gm3DItemsUI.GetUIElementType:
        // public UInt32 GetUIElementType() => ((delegate* unmanaged[Thiscall]<ref gm3DItemsUI, UInt32>)0xDEADBEEF)(ref this); // .text:004A70C0 ; unsigned int __thiscall gm3DItemsUI::GetUIElementType(gm3DItemsUI *this) .text:004A70C0 ?GetUIElementType@gm3DItemsUI@@UBEKXZ

        // gm3DItemsUI.PostInit:
        // public void PostInit() => ((delegate* unmanaged[Thiscall]<ref gm3DItemsUI, void>)0xDEADBEEF)(ref this); // .text:004A7190 ; void __thiscall gm3DItemsUI::PostInit(gm3DItemsUI *this) .text:004A7190 ?PostInit@gm3DItemsUI@@UAEXXZ
    ...
    public unsafe struct gmBackpackUI {
        ...
        // gmBackpackUI.__Ctor:
        // public void __Ctor(LayoutDesc* _layout, ElementDesc* _full_desc) => ((delegate* unmanaged[Thiscall]<ref gmBackpackUI, LayoutDesc*, ElementDesc*, void>)0xDEADBEEF)(ref this, _layout, _full_desc); // .text:004A6D70 ; void __thiscall gmBackpackUI::gmBackpackUI(gmBackpackUI *this, LayoutDesc *_layout, ElementDesc *_full_desc) .text:004A6D70 ??0gmBackpackUI@@QAE@ABVLayoutDesc@@ABVElementDesc@@@Z

        // gmBackpackUI.Create:
        // public static UIElement* Create(LayoutDesc* _layout, ElementDesc* _full_desc) => ((delegate* unmanaged[Cdecl]<LayoutDesc*, ElementDesc*, UIElement*>)0xDEADBEEF)(_layout, _full_desc); // .text:004A6DF0 ; UIElement *__cdecl gmBackpackUI::Create(LayoutDesc *_layout, ElementDesc *_full_desc) .text:004A6DF0 ?Create@gmBackpackUI@@SAPAVUIElement@@ABVLayoutDesc@@ABVElementDesc@@@Z

        // gmBackpackUI.DynamicCast:
        // public UIElement* DynamicCast(UInt32 i_eType) => ((delegate* unmanaged[Thiscall]<ref gmBackpackUI, UInt32, UIElement*>)0xDEADBEEF)(ref this, i_eType); // .text:004A6DC0 ; UIElement *__thiscall gmBackpackUI::DynamicCast(gmBackpackUI *this, unsigned int i_eType) .text:004A6DC0 ?DynamicCast@gmBackpackUI@@UAEPAVUIElement@@K@Z

        // gmBackpackUI.GetUIElementType:
        // public UInt32 GetUIElementType() => ((delegate* unmanaged[Thiscall]<ref gmBackpackUI, UInt32>)0xDEADBEEF)(ref this); // .text:004A6DE0 ; unsigned int __thiscall gmBackpackUI::GetUIElementType(gmBackpackUI *this) .text:004A6DE0 ?GetUIElementType@gmBackpackUI@@UBEKXZ

        // gmBackpackUI.PostInit:
        // public void PostInit() => ((delegate* unmanaged[Thiscall]<ref gmBackpackUI, void>)0xDEADBEEF)(ref this); // .text:004A6F70 ; void __thiscall gmBackpackUI::PostInit(gmBackpackUI *this) .text:004A6F70 ?PostInit@gmBackpackUI@@UAEXXZ

        // gmBackpackUI.RecvNotice_LoadChanged:
        // public void RecvNotice_LoadChanged(Single fNewLoad) => ((delegate* unmanaged[Thiscall]<ref gmBackpackUI, Single, void>)0xDEADBEEF)(ref this, fNewLoad); // .text:004A7080 ; void __thiscall gmBackpackUI::RecvNotice_LoadChanged(gmBackpackUI *this, float fNewLoad) .text:004A7080 ?RecvNotice_LoadChanged@gmBackpackUI@@UAEXM@Z

        // gmBackpackUI.RecvNotice_PlayerDescReceived:
        // public void RecvNotice_PlayerDescReceived(CACQualities* i_playerDesc, CPlayerModule* i_playerModule) => ((delegate* unmanaged[Thiscall]<ref gmBackpackUI, CACQualities*, CPlayerModule*, void>)0xDEADBEEF)(ref this, i_playerDesc, i_playerModule); // .text:004A7040 ; void __thiscall gmBackpackUI::RecvNotice_PlayerDescReceived(gmBackpackUI *this, CACQualities *i_playerDesc, CPlayerModule *i_playerModule) .text:004A7040 ?RecvNotice_PlayerDescReceived@gmBackpackUI@@UAEXABVCACQualities@@ABVCPlayerModule@@@Z
        ...
        // public void SetLoadLevel(Double _level) => ((delegate* unmanaged[Thiscall]<ref gmBackpackUI, Double, void>)0xDEADBEEF)(ref this, _level); // .text:004A6EA0 ; void __thiscall gmBackpackUI::SetLoadLevel(gmBackpackUI *this, long double _level) .text:004A6EA0 ?SetLoadLevel@gmBackpackUI@@QAEXN@Z
    }
    public unsafe struct gmPaperDollUI {
        ...
        // public UIElementMessageListenResult ListenToElementMessage(UIElementMessageInfo* i_rMsg) => ((delegate* unmanaged[Thiscall]<ref gmPaperDollUI, UIElementMessageInfo*, UIElementMessageListenResult>)0xDEADBEEF)(ref this, i_rMsg); // .text:004A5C30 ; UIElementMessageListenResult __thiscall gmPaperDollUI::ListenToElementMessage(gmPaperDollUI *this, UIElementMessageInfo *i_rMsg) .text:004A5C30 ?ListenToElementMessage@gmPaperDollUI@@UAE?AW4UIElementMessageListenResult@@ABUUIElementMessageInfo@@@Z
        ...
        // public Byte RemakeCharacterInventory() => ((delegate* unmanaged[Thiscall]<ref gmPaperDollUI, Byte>)0xDEADBEEF)(ref this); // .text:004A65C0 ; bool __thiscall gmPaperDollUI::RemakeCharacterInventory(gmPaperDollUI *this) .text:004A65C0 ?RemakeCharacterInventory@gmPaperDollUI@@QAE_NXZ

        // gmPaperDollUI.ServerSaysMoveItem:
        // public void ServerSaysMoveItem(UInt32 _itemID, UInt32 _oldContainer, UInt32 _oldWielder, UInt32 _oldLocation, UInt32 _newContainer, int _place, UInt32 _newWielder, UInt32 _newLocation) => ((delegate* unmanaged[Thiscall]<ref gmPaperDollUI, UInt32, UInt32, UInt32, UInt32, UInt32, int, UInt32, UInt32, void>)0xDEADBEEF)(ref this, _itemID, _oldContainer, _oldWielder, _oldLocation, _newContainer, _place, _newWielder, _newLocation); // .text:004A64A0 ; void __thiscall gmPaperDollUI::ServerSaysMoveItem(gmPaperDollUI *this, unsigned int _itemID, unsigned int _oldContainer, unsigned int _oldWielder, unsigned int _oldLocation, unsigned int _newContainer, int _place, unsigned int _newWielder, unsigned int _newLocation) .text:004A64A0 ?ServerSaysMoveItem@gmPaperDollUI@@IAEXKKKKKHKK@Z

        // gmPaperDollUI.SetUIItemIntoLocation:
        // public void SetUIItemIntoLocation(UInt32 _itemID, UInt32 _location) => ((delegate* unmanaged[Thiscall]<ref gmPaperDollUI, UInt32, UInt32, void>)0xDEADBEEF)(ref this, _itemID, _location); // .text:004A5F90 ; void __thiscall gmPaperDollUI::SetUIItemIntoLocation(gmPaperDollUI *this, unsigned int _itemID, unsigned int _location) .text:004A5F90 ?SetUIItemIntoLocation@gmPaperDollUI@@IAEXKK@Z
    ...
    public unsafe struct gmInventoryUI {
        ...
        // public void __Ctor(LayoutDesc* _layout, ElementDesc* _full_desc) => ((delegate* unmanaged[Thiscall]<ref gmInventoryUI, LayoutDesc*, ElementDesc*, void>)0xDEADBEEF)(ref this, _layout, _full_desc); // .text:004A6670 ; void __thiscall gmInventoryUI::gmInventoryUI(gmInventoryUI *this, LayoutDesc *_layout, ElementDesc *_full_desc) .text:004A6670 ??0gmInventoryUI@@QAE@ABVLayoutDesc@@ABVElementDesc@@@Z

        // gmInventoryUI.Create:
        // public static UIElement* Create(LayoutDesc* _layout, ElementDesc* _full_desc) => ((delegate* unmanaged[Cdecl]<LayoutDesc*, ElementDesc*, UIElement*>)0xDEADBEEF)(_layout, _full_desc); // .text:004A66F0 ; UIElement *__cdecl gmInventoryUI::Create(LayoutDesc *_layout, ElementDesc *_full_desc) .text:004A66F0 ?Create@gmInventoryUI@@SAPAVUIElement@@ABVLayoutDesc@@ABVElementDesc@@@Z

        // gmInventoryUI.DynamicCast:
        // public UIElement* DynamicCast(UInt32 i_eType) => ((delegate* unmanaged[Thiscall]<ref gmInventoryUI, UInt32, UIElement*>)0xDEADBEEF)(ref this, i_eType); // .text:004A66C0 ; UIElement *__thiscall gmInventoryUI::DynamicCast(gmInventoryUI *this, unsigned int i_eType) .text:004A66C0 ?DynamicCast@gmInventoryUI@@UAEPAVUIElement@@K@Z

        // gmInventoryUI.GetUIElementType:
        // public UInt32 GetUIElementType() => ((delegate* unmanaged[Thiscall]<ref gmInventoryUI, UInt32>)0xDEADBEEF)(ref this); // .text:004A66E0 ; unsigned int __thiscall gmInventoryUI::GetUIElementType(gmInventoryUI *this) .text:004A66E0 ?GetUIElementType@gmInventoryUI@@UBEKXZ

        // gmInventoryUI.PostInit:
        // public void PostInit() => ((delegate* unmanaged[Thiscall]<ref gmInventoryUI, void>)0xDEADBEEF)(ref this); // .text:004A6940 ; void __thiscall gmInventoryUI::PostInit(gmInventoryUI *this) .text:004A6940 ?PostInit@gmInventoryUI@@UAEXXZ

        // gmInventoryUI.RecvNotice_EndPendingInPlayer:
        // public void RecvNotice_EndPendingInPlayer() => ((delegate* unmanaged[Thiscall]<ref gmInventoryUI, void>)0xDEADBEEF)(ref this); // .text:004A68B0 ; void __thiscall gmInventoryUI::RecvNotice_EndPendingInPlayer(gmInventoryUI *this) .text:004A68B0 ?RecvNotice_EndPendingInPlayer@gmInventoryUI@@MAEXXZ

        // gmInventoryUI.RecvNotice_ItemAttributesChanged:
        // public void RecvNotice_ItemAttributesChanged(UInt32 i_target, UInt32 i_attrib) => ((delegate* unmanaged[Thiscall]<ref gmInventoryUI, UInt32, UInt32, void>)0xDEADBEEF)(ref this, i_target, i_attrib); // .text:004A6810 ; void __thiscall gmInventoryUI::RecvNotice_ItemAttributesChanged(gmInventoryUI *this, unsigned int i_target, unsigned int i_attrib) .text:004A6810 ?RecvNotice_ItemAttributesChanged@gmInventoryUI@@MAEXKK@Z

        // gmInventoryUI.RecvNotice_NewParentContainer:
        // public void RecvNotice_NewParentContainer(UInt32 i_newContainerID) => ((delegate* unmanaged[Thiscall]<ref gmInventoryUI, UInt32, void>)0xDEADBEEF)(ref this, i_newContainerID); // .text:004A6C90 ; void __thiscall gmInventoryUI::RecvNotice_NewParentContainer(gmInventoryUI *this, unsigned int i_newContainerID) .text:004A6C90 ?RecvNotice_NewParentContainer@gmInventoryUI@@MAEXK@Z

        // gmInventoryUI.RecvNotice_OpenContainedContainer:
        // public void RecvNotice_OpenContainedContainer(UInt32 i_containerID) => ((delegate* unmanaged[Thiscall]<ref gmInventoryUI, UInt32, void>)0xDEADBEEF)(ref this, i_containerID); // .text:004A6A80 ; void __thiscall gmInventoryUI::RecvNotice_OpenContainedContainer(gmInventoryUI *this, unsigned int i_containerID) .text:004A6A80 ?RecvNotice_OpenContainedContainer@gmInventoryUI@@MAEXK@Z

        // gmInventoryUI.RecvNotice_PlayerDescReceived:
        // public void RecvNotice_PlayerDescReceived(CACQualities* i_playerDesc, CPlayerModule* i_playerModule) => ((delegate* unmanaged[Thiscall]<ref gmInventoryUI, CACQualities*, CPlayerModule*, void>)0xDEADBEEF)(ref this, i_playerDesc, i_playerModule); // .text:004A6BC0 ; void __thiscall gmInventoryUI::RecvNotice_PlayerDescReceived(gmInventoryUI *this, CACQualities *i_playerDesc, CPlayerModule *i_playerModule) .text:004A6BC0 ?RecvNotice_PlayerDescReceived@gmInventoryUI@@MAEXABVCACQualities@@ABVCPlayerModule@@@Z

        // gmInventoryUI.RecvNotice_ServerSaysMoveItem:
        // public void RecvNotice_ServerSaysMoveItem(UInt32 _itemID, UInt32 _oldContainer, UInt32 _oldWielder, UInt32 _oldLocation, UInt32 _newContainer, int _place, UInt32 _newWielder, UInt32 _newLocation) => ((delegate* unmanaged[Thiscall]<ref gmInventoryUI, UInt32, UInt32, UInt32, UInt32, UInt32, int, UInt32, UInt32, void>)0xDEADBEEF)(ref this, _itemID, _oldContainer, _oldWielder, _oldLocation, _newContainer, _place, _newWielder, _newLocation); // .text:004A6840 ; void __thiscall gmInventoryUI::RecvNotice_ServerSaysMoveItem(gmInventoryUI *this, unsigned int _itemID, unsigned int _oldContainer, unsigned int _oldWielder, unsigned int _oldLocation, unsigned int _newContainer, int _place, unsigned int _newWielder, unsigned int _newLocation) .text:004A6840 ?RecvNotice_ServerSaysMoveItem@gmInventoryUI@@MAEXKKKKKHKK@Z

        // gmInventoryUI.RecvNotice_SetDisplayInventory:
        // public void RecvNotice_SetDisplayInventory(int display) => ((delegate* unmanaged[Thiscall]<ref gmInventoryUI, int, void>)0xDEADBEEF)(ref this, display); // .text:004A6750 ; void __thiscall gmInventoryUI::RecvNotice_SetDisplayInventory(gmInventoryUI *this, int display) .text:004A6750 ?RecvNotice_SetDisplayInventory@gmInventoryUI@@MAEXH@Z

        // gmInventoryUI.RecvNotice_ShowPendingInPlayer:
        // public void RecvNotice_ShowPendingInPlayer(UInt32 i_itemID) => ((delegate* unmanaged[Thiscall]<ref gmInventoryUI, UInt32, void>)0xDEADBEEF)(ref this, i_itemID); // .text:004A6B50 ; void __thiscall gmInventoryUI::RecvNotice_ShowPendingInPlayer(gmInventoryUI *this, unsigned int i_itemID) .text:004A6B50 ?RecvNotice_ShowPendingInPlayer@gmInventoryUI@@MAEXK@Z

        // gmInventoryUI.RecvNotice_UpdateCharacterInformation:
        // public void RecvNotice_UpdateCharacterInformation(CACQualities* i_playerDesc) => ((delegate* unmanaged[Thiscall]<ref gmInventoryUI, CACQualities*, void>)0xDEADBEEF)(ref this, i_playerDesc); // .text:004A6720 ; void __thiscall gmInventoryUI::RecvNotice_UpdateCharacterInformation(gmInventoryUI *this, CACQualities *i_playerDesc) .text:004A6720 ?RecvNotice_UpdateCharacterInformation@gmInventoryUI@@MAEXABVCACQualities@@@Z
    ...
    public unsafe struct gmExternalContainerUI {
        ...
        // public void __Ctor(LayoutDesc* _layout, ElementDesc* _full_desc) => ((delegate* unmanaged[Thiscall]<ref gmExternalContainerUI, LayoutDesc*, ElementDesc*, void>)0xDEADBEEF)(ref this, _layout, _full_desc); // .text:004CBD40 ; void __thiscall gmExternalContainerUI::gmExternalContainerUI(gmExternalContainerUI *this, LayoutDesc *_layout, ElementDesc *_full_desc) .text:004CBD40 ??0gmExternalContainerUI@@QAE@ABVLayoutDesc@@ABVElementDesc@@@Z

        // gmExternalContainerUI.CloseCurrentContainer:
        // public void CloseCurrentContainer() => ((delegate* unmanaged[Thiscall]<ref gmExternalContainerUI, void>)0xDEADBEEF)(ref this); // .text:004CBCB0 ; void __thiscall gmExternalContainerUI::CloseCurrentContainer(gmExternalContainerUI *this) .text:004CBCB0 ?CloseCurrentContainer@gmExternalContainerUI@@IAEXXZ

        // gmExternalContainerUI.Create:
        // public static UIElement* Create(LayoutDesc* _layout, ElementDesc* _full_desc) => ((delegate* unmanaged[Cdecl]<LayoutDesc*, ElementDesc*, UIElement*>)0xDEADBEEF)(_layout, _full_desc); // .text:004CBF20 ; UIElement *__cdecl gmExternalContainerUI::Create(LayoutDesc *_layout, ElementDesc *_full_desc) .text:004CBF20 ?Create@gmExternalContainerUI@@SAPAVUIElement@@ABVLayoutDesc@@ABVElementDesc@@@Z

        // gmExternalContainerUI.DragItemAcceptable:
        // public Byte DragItemAcceptable(UInt32 _itemID, Byte _silent) => ((delegate* unmanaged[Thiscall]<ref gmExternalContainerUI, UInt32, Byte, Byte>)0xDEADBEEF)(ref this, _itemID, _silent); // .text:004CBB60 ; bool __thiscall gmExternalContainerUI::DragItemAcceptable(gmExternalContainerUI *this, unsigned int _itemID, bool _silent) .text:004CBB60 ?DragItemAcceptable@gmExternalContainerUI@@IAE_NK_N@Z

        // gmExternalContainerUI.DynamicCast:
        // public UIElement* DynamicCast(UInt32 i_eType) => ((delegate* unmanaged[Thiscall]<ref gmExternalContainerUI, UInt32, UIElement*>)0xDEADBEEF)(ref this, i_eType); // .text:004CBAA0 ; UIElement *__thiscall gmExternalContainerUI::DynamicCast(gmExternalContainerUI *this, unsigned int i_eType) .text:004CBAA0 ?DynamicCast@gmExternalContainerUI@@UAEPAVUIElement@@K@Z

        // gmExternalContainerUI.GetUIElementType:
        // public UInt32 GetUIElementType() => ((delegate* unmanaged[Thiscall]<ref gmExternalContainerUI, UInt32>)0xDEADBEEF)(ref this); // .text:004CBAC0 ; unsigned int __thiscall gmExternalContainerUI::GetUIElementType(CombatManeuverTable *this) .text:004CBAC0 ?GetUIElementType@gmExternalContainerUI@@UBEKXZ

        // gmExternalContainerUI.ListenToElementMessage:
        // public UIElementMessageListenResult ListenToElementMessage(UIElementMessageInfo* i_rMsg) => ((delegate* unmanaged[Thiscall]<ref gmExternalContainerUI, UIElementMessageInfo*, UIElementMessageListenResult>)0xDEADBEEF)(ref this, i_rMsg); // .text:004CBAD0 ; UIElementMessageListenResult __thiscall gmExternalContainerUI::ListenToElementMessage(gmExternalContainerUI *this, UIElementMessageInfo *i_rMsg) .text:004CBAD0 ?ListenToElementMessage@gmExternalContainerUI@@UAE?AW4UIElementMessageListenResult@@ABUUIElementMessageInfo@@@Z

        // gmExternalContainerUI.OnItemListDragOver:
        // public Byte OnItemListDragOver(UIElement_UIItem* _catchElement, UInt32 _dropItemID, UInt32 _dropSpellID, DropItemFlags _dropFlags) => ((delegate* unmanaged[Thiscall]<ref gmExternalContainerUI, UIElement_UIItem*, UInt32, UInt32, DropItemFlags, Byte>)0xDEADBEEF)(ref this, _catchElement, _dropItemID, _dropSpellID, _dropFlags); // .text:004CBF80 ; bool __thiscall gmExternalContainerUI::OnItemListDragOver(gmExternalContainerUI *this, UIElement_UIItem *_catchElement, unsigned int _dropItemID, unsigned int _dropSpellID, DropItemFlags _dropFlags) .text:004CBF80 ?OnItemListDragOver@gmExternalContainerUI@@MAE_NPAVUIElement_UIItem@@KKW4DropItemFlags@@@Z

        // gmExternalContainerUI.OnObjectRangeExit:
        // public void OnObjectRangeExit(UInt32 _objectID) => ((delegate* unmanaged[Thiscall]<ref gmExternalContainerUI, UInt32, void>)0xDEADBEEF)(ref this, _objectID); // .text:004CBD10 ; void __thiscall gmExternalContainerUI::OnObjectRangeExit(gmExternalContainerUI *this, unsigned int _objectID) .text:004CBD10 ?OnObjectRangeExit@gmExternalContainerUI@@MAEXK@Z

        // gmExternalContainerUI.OnVisibilityChanged:
        // public void OnVisibilityChanged(Byte i_bVisible) => ((delegate* unmanaged[Thiscall]<ref gmExternalContainerUI, Byte, void>)0xDEADBEEF)(ref this, i_bVisible); // .text:004CBF50 ; void __thiscall gmExternalContainerUI::OnVisibilityChanged(gmExternalContainerUI *this, bool i_bVisible) .text:004CBF50 ?OnVisibilityChanged@gmExternalContainerUI@@MAEX_N@Z

        // gmExternalContainerUI.PostInit:
        // public void PostInit() => ((delegate* unmanaged[Thiscall]<ref gmExternalContainerUI, void>)0xDEADBEEF)(ref this); // .text:004CBDE0 ; void __thiscall gmExternalContainerUI::PostInit(gmExternalContainerUI *this) .text:004CBDE0 ?PostInit@gmExternalContainerUI@@UAEXXZ

        // gmExternalContainerUI.RecvNotice_ServerSaysMoveItem:
        // public void RecvNotice_ServerSaysMoveItem(UInt32 _itemID, UInt32 _oldContainer, UInt32 _oldWielder, UInt32 _oldLocation, UInt32 _newContainer, int _place, UInt32 _newWielder, UInt32 _newLocation) => ((delegate* unmanaged[Thiscall]<ref gmExternalContainerUI, UInt32, UInt32, UInt32, UInt32, UInt32, int, UInt32, UInt32, void>)0xDEADBEEF)(ref this, _itemID, _oldContainer, _oldWielder, _oldLocation, _newContainer, _place, _newWielder, _newLocation); // .text:004CBB30 ; void __thiscall gmExternalContainerUI::RecvNotice_ServerSaysMoveItem(gmExternalContainerUI *this, unsigned int _itemID, unsigned int _oldContainer, unsigned int _oldWielder, unsigned int _oldLocation, unsigned int _newContainer, int _place, unsigned int _newWielder, unsigned int _newLocation) .text:004CBB30 ?RecvNotice_ServerSaysMoveItem@gmExternalContainerUI@@MAEXKKKKKHKK@Z

        // gmExternalContainerUI.RecvNotice_SetGroundObject:
        // public void RecvNotice_SetGroundObject(UInt32 i_objid) => ((delegate* unmanaged[Thiscall]<ref gmExternalContainerUI, UInt32, void>)0xDEADBEEF)(ref this, i_objid); // .text:004CBFD0 ; void __thiscall gmExternalContainerUI::RecvNotice_SetGroundObject(gmExternalContainerUI *this, unsigned int i_objid) .text:004CBFD0 ?RecvNotice_SetGroundObject@gmExternalContainerUI@@MAEXK@Z

        // gmExternalContainerUI.RecvNotice_StopViewingObject:
        // public void RecvNotice_StopViewingObject(UInt32 i_objid) => ((delegate* unmanaged[Thiscall]<ref gmExternalContainerUI, UInt32, void>)0xDEADBEEF)(ref this, i_objid); // .text:004CBB00 ; void __thiscall gmExternalContainerUI::RecvNotice_StopViewingObject(gmExternalContainerUI *this, unsigned int i_objid) .text:004CBB00 ?RecvNotice_StopViewingObject@gmExternalContainerUI@@MAEXK@Z
        ...
        // public void SetGroundObject(UInt32 _groundObjectID) => ((delegate* unmanaged[Thiscall]<ref gmExternalContainerUI, UInt32, void>)0xDEADBEEF)(ref this, _groundObjectID); // .text:004CBBD0 ; void __thiscall gmExternalContainerUI::SetGroundObject(gmExternalContainerUI *this, unsigned int _groundObjectID) .text:004CBBD0 ?SetGroundObject@gmExternalContainerUI@@IAEXK@Z
    }
