...
namespace AcClient {
    ...
    public unsafe struct CPhysicsPart {
        ...
        public static CPhysicsPart* makePhysicsPart(CPhysicsPart* pTemplate) => ((delegate* unmanaged[Cdecl]<CPhysicsPart*, CPhysicsPart*>)0x0050E230)(pTemplate); // .text:0050E230 ; CPhysicsPart *__cdecl CPhysicsPart::makePhysicsPart(CPhysicsPart *pTemplate) .text:0050E230 ?makePhysicsPart@CPhysicsPart@@SAPAV1@PBV1@@Z

        // CPhysicsPart.SetGfxObjArray:
        public void SetGfxObjArray(GfxObjDegradeInfo* new_degrades, CGfxObj** new_gfxobj) => ((delegate* unmanaged[Thiscall]<ref CPhysicsPart, GfxObjDegradeInfo*, CGfxObj**, void>)0x0050E2E0)(ref this, new_degrades, new_gfxobj); // .text:0050E2E0 ; void __thiscall CPhysicsPart::SetGfxObjArray(CPhysicsPart *this, GfxObjDegradeInfo *new_degrades, CGfxObj **new_gfxobj) .text:0050E2E0 ?SetGfxObjArray@CPhysicsPart@@IAEXPAVGfxObjDegradeInfo@@PAPAVCGfxObj@@@Z

        // CPhysicsPart.SetLighting:
        public void SetLighting(Single _luminosity, Single _diffuse) => ((delegate* unmanaged[Thiscall]<ref CPhysicsPart, Single, Single, void>)0x0050E400)(ref this, _luminosity, _diffuse); // .text:0050E400 ; void __thiscall CPhysicsPart::SetLighting(CPhysicsPart *this, float _luminosity, float _diffuse) .text:0050E400 ?SetLighting@CPhysicsPart@@QAEXMM@Z

        // CPhysicsPart.SetDiffusion:
        public void SetDiffusion(Single _diffuse) => ((delegate* unmanaged[Thiscall]<ref CPhysicsPart, Single, void>)0x0050E570)(ref this, _diffuse); // .text:0050E570 ; void __thiscall CPhysicsPart::SetDiffusion(CPhysicsPart *this, float _diffuse) .text:0050E570 ?SetDiffusion@CPhysicsPart@@QAEXM@Z

        // CPhysicsPart.ReleaseGfxObjArray:
        public static void ReleaseGfxObjArray(GfxObjDegradeInfo** old_degrades, CGfxObj** old_gfxobj) => ((delegate* unmanaged[Cdecl]<GfxObjDegradeInfo**, CGfxObj**, void>)0x0050D530)(old_degrades, old_gfxobj); // .text:0050D530 ; void __cdecl CPhysicsPart::ReleaseGfxObjArray(GfxObjDegradeInfo **old_degrades, CGfxObj ***old_gfxobj) .text:0050D530 ?ReleaseGfxObjArray@CPhysicsPart@@KAXAAPAVGfxObjDegradeInfo@@AAPAPAVCGfxObj@@@Z

        // CPhysicsPart.Draw:
        public void Draw(int building_flag) => ((delegate* unmanaged[Thiscall]<ref CPhysicsPart, int, void>)0x0050D7A0)(ref this, building_flag); // .text:0050D7A0 ; void __thiscall CPhysicsPart::Draw(CPhysicsPart *this, int building_flag) .text:0050D7A0 ?Draw@CPhysicsPart@@QAEXH@Z

        // CPhysicsPart.MorphToExistingObject:
        public Byte MorphToExistingObject(CPhysicsPart* pTemplate) => ((delegate* unmanaged[Thiscall]<ref CPhysicsPart, CPhysicsPart*, Byte>)0x0050DB70)(ref this, pTemplate); // .text:0050DB70 ; bool __thiscall CPhysicsPart::MorphToExistingObject(CPhysicsPart *this, CPhysicsPart *pTemplate) .text:0050DB70 ?MorphToExistingObject@CPhysicsPart@@IAE_NPBV1@@Z

        // CPhysicsPart.RestoreMaterial:
        public void RestoreMaterial() => ((delegate* unmanaged[Thiscall]<ref CPhysicsPart, void>)0x0050DF70)(ref this); // .text:0050DF70 ; void __thiscall CPhysicsPart::RestoreMaterial(CPhysicsPart *this) .text:0050DF70 ?RestoreMaterial@CPhysicsPart@@QAEXXZ

        // CPhysicsPart.UpdateViewerDistance:
        public void UpdateViewerDistance(Single _CYpt, AC1Legacy.Vector3* _viewer_heading) => ((delegate* unmanaged[Thiscall]<ref CPhysicsPart, Single, AC1Legacy.Vector3*, void>)0x0050E1A0)(ref this, _CYpt, _viewer_heading); // .text:0050E1A0 ; void __thiscall CPhysicsPart::UpdateViewerDistance(CPhysicsPart *this, float _CYpt, AC1Legacy::Vector3 *_viewer_heading) .text:0050E1A0 ?UpdateViewerDistance@CPhysicsPart@@QAEXMABVVector3@AC1Legacy@@@Z

        // CPhysicsPart.GetOriginalPaletteID:
        public UInt32* GetOriginalPaletteID(UInt32* result) => ((delegate* unmanaged[Thiscall]<ref CPhysicsPart, UInt32*, UInt32*>)0x0050D5A0)(ref this, result); // .text:0050D5A0 ; IDClass<_tagDataID,32,0> *__thiscall CPhysicsPart::GetOriginalPaletteID(CPhysicsPart *this, IDClass<_tagDataID,32,0> *result) .text:0050D5A0 ?GetOriginalPaletteID@CPhysicsPart@@QBE?AV?$IDClass@U_tagDataID@@$0CA@$0A@@@XZ

        // CPhysicsPart.CurSettingsAreDefault:
        public Byte CurSettingsAreDefault() => ((delegate* unmanaged[Thiscall]<ref CPhysicsPart, Byte>)0x0050D9E0)(ref this); // .text:0050D9E0 ; bool __thiscall CPhysicsPart::CurSettingsAreDefault(CPhysicsPart *this) .text:0050D9E0 ?CurSettingsAreDefault@CPhysicsPart@@IAE_NXZ

        // CPhysicsPart.LoadGfxObjArray:
        public static int LoadGfxObjArray(UInt32 i_idRootObject, GfxObjDegradeInfo** new_degrades, CGfxObj** new_gfxobj) => ((delegate* unmanaged[Cdecl]<UInt32, GfxObjDegradeInfo**, CGfxObj**, int>)0x0050DCF0)(i_idRootObject, new_degrades, new_gfxobj); // .text:0050DCF0 ; int __cdecl CPhysicsPart::LoadGfxObjArray(IDClass<_tagDataID,32,0> i_idRootObject, GfxObjDegradeInfo **new_degrades, CGfxObj ***new_gfxobj) .text:0050DCF0 ?LoadGfxObjArray@CPhysicsPart@@KAHV?$IDClass@U_tagDataID@@$0CA@$0A@@@AAPAVGfxObjDegradeInfo@@AAPAPAVCGfxObj@@@Z

        // CPhysicsPart.makePhysicsPart:
        public static CPhysicsPart* makePhysicsPart(UInt32 gfxobj_id) => ((delegate* unmanaged[Cdecl]<UInt32, CPhysicsPart*>)0x0050E760)(gfxobj_id); // .text:0050E760 ; CPhysicsPart *__cdecl CPhysicsPart::makePhysicsPart(IDClass<_tagDataID,32,0> gfxobj_id) .text:0050E760 ?makePhysicsPart@CPhysicsPart@@SAPAV1@V?$IDClass@U_tagDataID@@$0CA@$0A@@@@Z

        // CPhysicsPart.GetBoundingBox:
        public BBox* GetBoundingBox() => ((delegate* unmanaged[Thiscall]<ref CPhysicsPart, BBox*>)0x0050D600)(ref this); // .text:0050D600 ; BBox *__thiscall CPhysicsPart::GetBoundingBox(CPhysicsPart *this) .text:0050D600 ?GetBoundingBox@CPhysicsPart@@QBEABVBBox@@XZ

        // CPhysicsPart.CopySurfaces:
        public int CopySurfaces() => ((delegate* unmanaged[Thiscall]<ref CPhysicsPart, int>)0x0050D6A0)(ref this); // .text:0050D6A0 ; int __thiscall CPhysicsPart::CopySurfaces(CPhysicsPart *this) .text:0050D6A0 ?CopySurfaces@CPhysicsPart@@QAEHXZ

        // CPhysicsPart.Always2D:
        public int Always2D() => ((delegate* unmanaged[Thiscall]<ref CPhysicsPart, int>)0x0050D8A0)(ref this); // .text:0050D8A0 ; int __thiscall CPhysicsPart::Always2D(CPhysicsPart *this) .text:0050D8A0 ?Always2D@CPhysicsPart@@QBEHXZ

        // CPhysicsPart.UsePalette:
        public int UsePalette(Palette* pal) => ((delegate* unmanaged[Thiscall]<ref CPhysicsPart, Palette*, int>)0x0050DED0)(ref this, pal); // .text:0050DED0 ; int __thiscall CPhysicsPart::UsePalette(CPhysicsPart *this, Palette *pal) .text:0050DED0 ?UsePalette@CPhysicsPart@@QAEHPAVPalette@@@Z

        // CPhysicsPart.RestoreLighting:
        public void RestoreLighting() => ((delegate* unmanaged[Thiscall]<ref CPhysicsPart, void>)0x0050E4A0)(ref this); // .text:0050E4A0 ; void __thiscall CPhysicsPart::RestoreLighting(CPhysicsPart *this) .text:0050E4A0 ?RestoreLighting@CPhysicsPart@@QAEXXZ

        // CPhysicsPart.SetNoDraw:
        public void SetNoDraw(int no_draw) => ((delegate* unmanaged[Thiscall]<ref CPhysicsPart, int, void>)0x0050D610)(ref this, no_draw); // .text:0050D610 ; void __thiscall CPhysicsPart::SetNoDraw(CPhysicsPart *this, int no_draw) .text:0050D610 ?SetNoDraw@CPhysicsPart@@QAEXH@Z

        // CPhysicsPart.CopyMaterial:
        public int CopyMaterial() => ((delegate* unmanaged[Thiscall]<ref CPhysicsPart, int>)0x0050D630)(ref this); // .text:0050D630 ; int __thiscall CPhysicsPart::CopyMaterial(CPhysicsPart *this) .text:0050D630 ?CopyMaterial@CPhysicsPart@@QAEHXZ

        // CPhysicsPart.__Ctor:
        public void __Ctor() => ((delegate* unmanaged[Thiscall]<ref CPhysicsPart, void>)0x0050DA80)(ref this); // .text:0050DA80 ; void __thiscall CPhysicsPart::CPhysicsPart(CPhysicsPart *this) .text:0050DA80 ??0CPhysicsPart@@IAE@XZ

        // CPhysicsPart.SetTextureMap:
        public int SetTextureMap(UInt32 old_tex_id, UInt32 new_tex_id) => ((delegate* unmanaged[Thiscall]<ref CPhysicsPart, UInt32, UInt32, int>)0x0050DE30)(ref this, old_tex_id, new_tex_id); // .text:0050DE30 ; int __thiscall CPhysicsPart::SetTextureMap(CPhysicsPart *this, IDClass<_tagDataID,32,0> old_tex_id, IDClass<_tagDataID,32,0> new_tex_id) .text:0050DE30 ?SetTextureMap@CPhysicsPart@@QAEHV?$IDClass@U_tagDataID@@$0CA@$0A@@@0@Z

        // CPhysicsPart.SetLuminosity:
        public void SetLuminosity(Single _luminosity) => ((delegate* unmanaged[Thiscall]<ref CPhysicsPart, Single, void>)0x0050E5F0)(ref this, _luminosity); // .text:0050E5F0 ; void __thiscall CPhysicsPart::SetLuminosity(CPhysicsPart *this, float _luminosity) .text:0050E5F0 ?SetLuminosity@CPhysicsPart@@QAEXM@Z

        // CPhysicsPart.SetDrawnThisFrame:
        public void SetDrawnThisFrame() => ((delegate* unmanaged[Thiscall]<ref CPhysicsPart, void>)0x0050D4F0)(ref this); // .text:0050D4F0 ; void __thiscall CPhysicsPart::SetDrawnThisFrame(CPhysicsPart *this) .text:0050D4F0 ?SetDrawnThisFrame@CPhysicsPart@@QAEXXZ

        // CPhysicsPart.calc_draw_frame:
        public void calc_draw_frame() => ((delegate* unmanaged[Thiscall]<ref CPhysicsPart, void>)0x0050DFA0)(ref this); // .text:0050DFA0 ; void __thiscall CPhysicsPart::calc_draw_frame(CPhysicsPart *this) .text:0050DFA0 ?calc_draw_frame@CPhysicsPart@@IAEXXZ

        // CPhysicsPart.UpdateViewerDistance:
        public void UpdateViewerDistance() => ((delegate* unmanaged[Thiscall]<ref CPhysicsPart, void>)0x0050E030)(ref this); // .text:0050E030 ; void __thiscall CPhysicsPart::UpdateViewerDistance(CPhysicsPart *this) .text:0050E030 ?UpdateViewerDistance@CPhysicsPart@@QAEXXZ

        // CPhysicsPart.find_obj_collisions:
        public TransitionState find_obj_collisions(CTransition* transition) => ((delegate* unmanaged[Thiscall]<ref CPhysicsPart, CTransition*, TransitionState>)0x0050D8D0)(ref this, transition); // .text:0050D8D0 ; TransitionState __thiscall CPhysicsPart::find_obj_collisions(CPhysicsPart *this, CTransition *transition) .text:0050D8D0 ?find_obj_collisions@CPhysicsPart@@QBE?AW4TransitionState@@AAVCTransition@@@Z

        // CPhysicsPart.DetermineBasePal:
        public void DetermineBasePal() => ((delegate* unmanaged[Thiscall]<ref CPhysicsPart, void>)0x0050DC80)(ref this); // .text:0050DC80 ; void __thiscall CPhysicsPart::DetermineBasePal(CPhysicsPart *this) .text:0050DC80 ?DetermineBasePal@CPhysicsPart@@IAEXXZ

        // CPhysicsPart.IsPartOfPlayerObj:
        public Byte IsPartOfPlayerObj() => ((delegate* unmanaged[Thiscall]<ref CPhysicsPart, Byte>)0x0050D4B0)(ref this); // .text:0050D4B0 ; bool __thiscall CPhysicsPart::IsPartOfPlayerObj(CPhysicsPart *this) .text:0050D4B0 ?IsPartOfPlayerObj@CPhysicsPart@@QBE_NXZ

        // CPhysicsPart.GetDrawnThisFrame:
        public Byte GetDrawnThisFrame() => ((delegate* unmanaged[Thiscall]<ref CPhysicsPart, Byte>)0x0050D4D0)(ref this); // .text:0050D4D0 ; bool __thiscall CPhysicsPart::GetDrawnThisFrame(CPhysicsPart *this) .text:0050D4D0 ?GetDrawnThisFrame@CPhysicsPart@@QAE_NXZ

        // CPhysicsPart.GetMaxDegradeDistance:
        public Single GetMaxDegradeDistance() => ((delegate* unmanaged[Thiscall]<ref CPhysicsPart, Single>)0x0050D510)(ref this); // .text:0050D510 ; float __thiscall CPhysicsPart::GetMaxDegradeDistance(CPhysicsPart *this) .text:0050D510 ?GetMaxDegradeDistance@CPhysicsPart@@QBEMXZ

        // CPhysicsPart.RestorePalette:
        public void RestorePalette() => ((delegate* unmanaged[Thiscall]<ref CPhysicsPart, void>)0x0050D5B0)(ref this); // .text:0050D5B0 ; void __thiscall CPhysicsPart::RestorePalette(CPhysicsPart *this) .text:0050D5B0 ?RestorePalette@CPhysicsPart@@QAEXXZ

        // CPhysicsPart.RestoreSurfaces:
        public void RestoreSurfaces() => ((delegate* unmanaged[Thiscall]<ref CPhysicsPart, void>)0x0050D730)(ref this); // .text:0050D730 ; void __thiscall CPhysicsPart::RestoreSurfaces(CPhysicsPart *this) .text:0050D730 ?RestoreSurfaces@CPhysicsPart@@QAEXXZ

        // CPhysicsPart.get_physobj_id:
        public UInt32 get_physobj_id() => ((delegate* unmanaged[Thiscall]<ref CPhysicsPart, UInt32>)0x0050D490)(ref this); // .text:0050D490 ; unsigned int __thiscall CPhysicsPart::get_physobj_id(CPhysicsPart *this) .text:0050D490 ?get_physobj_id@CPhysicsPart@@QBEKXZ

        // CPhysicsPart.InitObjDescChanges:
        public int InitObjDescChanges() => ((delegate* unmanaged[Thiscall]<ref CPhysicsPart, int>)0x0050E3B0)(ref this); // .text:0050E3B0 ; int __thiscall CPhysicsPart::InitObjDescChanges(CPhysicsPart *this) .text:0050E3B0 ?InitObjDescChanges@CPhysicsPart@@QAEHXZ

        // CPhysicsPart.SetTranslucency:
        public void SetTranslucency(Single _translucency) => ((delegate* unmanaged[Thiscall]<ref CPhysicsPart, Single, void>)0x0050E670)(ref this, _translucency); // .text:0050E670 ; void __thiscall CPhysicsPart::SetTranslucency(CPhysicsPart *this, float _translucency) .text:0050E670 ?SetTranslucency@CPhysicsPart@@QAEXM@Z

        // CPhysicsPart.SetPart:
        public int SetPart(UInt32 gfxobj_id) => ((delegate* unmanaged[Thiscall]<ref CPhysicsPart, UInt32, int>)0x0050E700)(ref this, gfxobj_id); // .text:0050E700 ; int __thiscall CPhysicsPart::SetPart(CPhysicsPart *this, IDClass<_tagDataID,32,0> gfxobj_id) .text:0050E700 ?SetPart@CPhysicsPart@@QAEHV?$IDClass@U_tagDataID@@$0CA@$0A@@@@Z

        // Globals:
        public static int* creature_mode = (int*)0x00843BF4; // .data:00843BF4 ; int CPhysicsPart::creature_mode .data:00843BF4 ?creature_mode@CPhysicsPart@@1HA
        public static UInt32* player_iid = (UInt32*)0x00843BF8; // .data:00843BF8 ; unsigned int CPhysicsPart::player_iid .data:00843BF8 ?player_iid@CPhysicsPart@@1KA
        public static UInt32* viewcone_check_object_id = (UInt32*)0x00843BEC; // .data:00843BEC ; unsigned int CPhysicsPart::viewcone_check_object_id .data:00843BEC ?viewcone_check_object_id@CPhysicsPart@@1KA
        public static int* selected_object_in_view = (int*)0x00843BF0; // .data:00843BF0 ; int CPhysicsPart::selected_object_in_view .data:00843BF0 ?selected_object_in_view@CPhysicsPart@@1HA
    }
