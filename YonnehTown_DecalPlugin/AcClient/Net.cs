...
namespace AcClient {
    ...
    public unsafe struct ClientNetConfiguration {
        ...
        public override string ToString() => $"LoggingFunctions(LoggingFunctions):{LoggingFunctions}, DesiredInterface(AC1Legacy.PStringBase<Char>):{DesiredInterface}, dwPort:{dwPort:X8}, bAutoGenerateUniquePort:{bAutoGenerateUniquePort}";
    }
