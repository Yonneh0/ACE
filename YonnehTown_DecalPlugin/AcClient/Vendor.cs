...
namespace AcClient {
    public unsafe struct VendorProfile {
        ...
        public override string ToString() => $"a0(PackObj):{a0}, item_types:{item_types:X8}, min_value(int):{min_value}, max_value(int):{max_value}, magic(int):{magic}, buy_price:{buy_price:n5}, sell_price:{sell_price:n5}, trade_id:{trade_id:X8}, trade_num(int):{trade_num}, trade_name(AC1Legacy.PStringBase<char>):{trade_name}";
