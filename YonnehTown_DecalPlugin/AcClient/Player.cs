...
namespace AcClient {
    ...
    public unsafe struct CPlayerSystem {
        ...
        public Int32 unblockAttemptNum;
    ...
    public unsafe struct CPlayerModule {
        // Struct:
        public Interface a0;
        public PlayerModule a1;
        public Byte m_bDirty;
        public Double m_timeFirstDirtied;
        public override string ToString() => $"a0(Interface):{a0}, a1(PlayerModule):{a1}, m_bDirty:{m_bDirty:X2}, m_timeFirstDirtied:{m_timeFirstDirtied:n5}";

        // Functions:

        // CPlayerModule.__Ctor:
        public void __Ctor() => ((delegate* unmanaged[Thiscall]<ref CPlayerModule, void>)0x0059B760)(ref this); // .text:0059A750 ; void __thiscall CPlayerModule::CPlayerModule(CPlayerModule *this) .text:0059A750 ??0CPlayerModule@@QAE@XZ

        // CPlayerModule.IsAutoSaveOption:
        public Byte IsAutoSaveOption(PlayerOption i_po) => ((delegate* unmanaged[Thiscall]<ref CPlayerModule, PlayerOption, Byte>)0x0059B600)(ref this, i_po); // .text:0059A600 ; bool __thiscall CPlayerModule::IsAutoSaveOption(CPlayerModule *this, PlayerOption i_po) .text:0059A600 ?IsAutoSaveOption@CPlayerModule@@IAE_NW4PlayerOption@@@Z

        // CPlayerModule.OnChanged:
        public void OnChanged(BaseProperty* i_prop, UInt32 i_nUserData) => ((delegate* unmanaged[Thiscall]<ref CPlayerModule, BaseProperty*, UInt32, void>)0x0059B8A0)(ref this, i_prop, i_nUserData); // .text:0059A890 ; void __thiscall CPlayerModule::OnChanged(CPlayerModule *this, BaseProperty *i_prop, unsigned int i_nUserData) .text:0059A890 ?OnChanged@CPlayerModule@@MAEXABVBaseProperty@@K@Z

        // CPlayerModule.OnChanged:
        public void OnChanged(PlayerOption i_po) => ((delegate* unmanaged[Thiscall]<ref CPlayerModule, PlayerOption, void>)0x0059B8F0)(ref this, i_po); // .text:0059A8E0 ; void __thiscall CPlayerModule::OnChanged(CPlayerModule *this, PlayerOption i_po) .text:0059A8E0 ?OnChanged@CPlayerModule@@MAEXW4PlayerOption@@@Z

        // CPlayerModule.OnInitialize:
        public void OnInitialize() => ((delegate* unmanaged[Thiscall]<ref CPlayerModule, void>)0x0059B6A0)(ref this); // .text:0059A690 ; void __thiscall CPlayerModule::OnInitialize(CPlayerModule *this) .text:0059A690 ?OnInitialize@CPlayerModule@@QAEXXZ

        // CPlayerModule.QueryInterface:
        public TResult* QueryInterface(TResult* result, Turbine_GUID* i_rcInterface, void** o_ppvInterface) => ((delegate* unmanaged[Thiscall]<ref CPlayerModule, TResult*, Turbine_GUID*, void**, TResult*>)0x0059B7E0)(ref this, result, i_rcInterface, o_ppvInterface); // .text:0059A7D0 ; TResult *__thiscall CPlayerModule::QueryInterface(CPlayerModule *this, TResult *result, Turbine_GUID *i_rcInterface, void **o_ppvInterface) .text:0059A7D0 ?QueryInterface@CPlayerModule@@UAE?AVTResult@@ABUTurbine_GUID@@PAPAX@Z

        // CPlayerModule.SaveToServer:
        public void SaveToServer(Byte i_bForceUpdate) => ((delegate* unmanaged[Thiscall]<ref CPlayerModule, Byte, void>)0x0059B670)(ref this, i_bForceUpdate); // .text:0059A660 ; void __thiscall CPlayerModule::SaveToServer(CPlayerModule *this, bool i_bForceUpdate) .text:0059A660 ?SaveToServer@CPlayerModule@@QAEX_N@Z

        // CPlayerModule.UseTime:
        public void UseTime() => ((delegate* unmanaged[Thiscall]<ref CPlayerModule, void>)0x0059B720)(ref this); // .text:0059A710 ; void __thiscall CPlayerModule::UseTime(CPlayerModule *this) .text:0059A710 ?UseTime@CPlayerModule@@QAEXXZ
    }
    ...
    public unsafe struct ExperienceSystem {
        ...
        // ExperienceSystem.Attribute2ndLevelFromExperience:
        public static UInt32 Attribute2ndLevelFromExperience(UInt32 total_xp) => ((delegate* unmanaged[Cdecl]<UInt32, UInt32>)0x005C94D0)(total_xp); // .text:005C84F0 ; unsigned int __cdecl ExperienceSystem::Attribute2ndLevelFromExperience(unsigned int total_xp) .text:005C84F0 ?Attribute2ndLevelFromExperience@ExperienceSystem@@SAKK@Z

        // ExperienceSystem.AttributeLevelFromExperience:
        public static UInt32 AttributeLevelFromExperience(UInt32 total_xp) => ((delegate* unmanaged[Cdecl]<UInt32, UInt32>)0x005C9490)(total_xp); // .text:005C84B0 ; unsigned int __cdecl ExperienceSystem::AttributeLevelFromExperience(unsigned int total_xp) .text:005C84B0 ?AttributeLevelFromExperience@ExperienceSystem@@SAKK@Z

        // ExperienceSystem.ExperienceToAttribute2ndLevel:
        public static UInt32 ExperienceToAttribute2ndLevel(UInt32 level) => ((delegate* unmanaged[Cdecl]<UInt32, UInt32>)0x005C9370)(level); // .text:005C8390 ; unsigned int __cdecl ExperienceSystem::ExperienceToAttribute2ndLevel(unsigned int level) .text:005C8390 ?ExperienceToAttribute2ndLevel@ExperienceSystem@@SAKK@Z

        // ExperienceSystem.ExperienceToAttributeLevel:
        public static UInt32 ExperienceToAttributeLevel(UInt32 level) => ((delegate* unmanaged[Cdecl]<UInt32, UInt32>)0x005C9330)(level); // .text:005C8350 ; unsigned int __cdecl ExperienceSystem::ExperienceToAttributeLevel(unsigned int level) .text:005C8350 ?ExperienceToAttributeLevel@ExperienceSystem@@SAKK@Z

        // ExperienceSystem.ExperienceToLevel:
        public static UInt64 ExperienceToLevel(UInt32 level) => ((delegate* unmanaged[Cdecl]<UInt32, UInt64>)0x005C9510)(level); // .text:005C8530 ; unsigned __int64 __cdecl ExperienceSystem::ExperienceToLevel(unsigned int level) .text:005C8530 ?ExperienceToLevel@ExperienceSystem@@SA_KK@Z

        // ExperienceSystem.ExperienceToRaiseLevel:
        public static UInt64 ExperienceToRaiseLevel(UInt32 current_level, UInt32 new_level) => ((delegate* unmanaged[Cdecl]<UInt32, UInt32, UInt64>)0x005C9610)(current_level, new_level); // .text:005C8630 ; unsigned __int64 __cdecl ExperienceSystem::ExperienceToRaiseLevel(unsigned int current_level, unsigned int new_level) .text:005C8630 ?ExperienceToRaiseLevel@ExperienceSystem@@SA_KKK@Z

        // ExperienceSystem.ExperienceToSkillLevel:
        public static UInt32 ExperienceToSkillLevel(SKILL_ADVANCEMENT_CLASS sac, UInt32 level) => ((delegate* unmanaged[Cdecl]<SKILL_ADVANCEMENT_CLASS, UInt32, UInt32>)0x005C93B0)(sac, level); // .text:005C83D0 ; unsigned int __cdecl ExperienceSystem::ExperienceToSkillLevel(SKILL_ADVANCEMENT_CLASS sac, unsigned int level) .text:005C83D0 ?ExperienceToSkillLevel@ExperienceSystem@@SAKW4SKILL_ADVANCEMENT_CLASS@@K@Z

        // ExperienceSystem.GetMaxAttribute2ndLevel:
        public static UInt32 GetMaxAttribute2ndLevel() => ((delegate* unmanaged[Cdecl]<UInt32>)0x005C95E0)(); // .text:005C8600 ; unsigned int __cdecl ExperienceSystem::GetMaxAttribute2ndLevel() .text:005C8600 ?GetMaxAttribute2ndLevel@ExperienceSystem@@SAKXZ

        // ExperienceSystem.GetMaxAttributeLevel:
        public static UInt32 GetMaxAttributeLevel() => ((delegate* unmanaged[Cdecl]<UInt32>)0x005C95B0)(); // .text:005C85D0 ; unsigned int __cdecl ExperienceSystem::GetMaxAttributeLevel() .text:005C85D0 ?GetMaxAttributeLevel@ExperienceSystem@@SAKXZ

        // ExperienceSystem.GetMaxSpecializedSkillLevel:
        public static UInt32 GetMaxSpecializedSkillLevel() => ((delegate* unmanaged[Cdecl]<UInt32>)0x005C9550)(); // .text:005C8570 ; unsigned int __cdecl ExperienceSystem::GetMaxSpecializedSkillLevel() .text:005C8570 ?GetMaxSpecializedSkillLevel@ExperienceSystem@@SAKXZ

        // ExperienceSystem.GetMaxTrainedSkillLevel:
        public static UInt32 GetMaxTrainedSkillLevel() => ((delegate* unmanaged[Cdecl]<UInt32>)0x005C9580)(); // .text:005C85A0 ; unsigned int __cdecl ExperienceSystem::GetMaxTrainedSkillLevel() .text:005C85A0 ?GetMaxTrainedSkillLevel@ExperienceSystem@@SAKXZ

        // ExperienceSystem.ItemLevelToTotalXP:
        public static UInt64 ItemLevelToTotalXP(int _item_level, UInt64 _base_xp, int _max_level, int _xp_scheme) => ((delegate* unmanaged[Cdecl]<int, UInt64, int, int, UInt64>)0x005C90E0)(_item_level, _base_xp, _max_level, _xp_scheme); // .text:005C8100 ; unsigned __int64 __cdecl ExperienceSystem::ItemLevelToTotalXP(int _item_level, unsigned __int64 _base_xp, int _max_level, int _xp_scheme) .text:005C8100 ?ItemLevelToTotalXP@ExperienceSystem@@SA_KJ_KJJ@Z

        // ExperienceSystem.ItemTotalXPToLevel:
        public static int ItemTotalXPToLevel(UInt64 _gained_xp, UInt64 _base_xp, int _max_level, int _xp_scheme) => ((delegate* unmanaged[Cdecl]<UInt64, UInt64, int, int, int>)0x005C9190)(_gained_xp, _base_xp, _max_level, _xp_scheme); // .text:005C81B0 ; int __cdecl ExperienceSystem::ItemTotalXPToLevel(unsigned __int64 _gained_xp, unsigned __int64 _base_xp, int _max_level, int _xp_scheme) .text:005C81B0 ?ItemTotalXPToLevel@ExperienceSystem@@SAJ_K0JJ@Z

        // ExperienceSystem.SkillLevelFromExperience:
        public static UInt32 SkillLevelFromExperience(SKILL_ADVANCEMENT_CLASS sac, UInt32 pp) => ((delegate* unmanaged[Cdecl]<SKILL_ADVANCEMENT_CLASS, UInt32, UInt32>)0x005C9420)(sac, pp); // .text:005C8440 ; unsigned int __cdecl ExperienceSystem::SkillLevelFromExperience(SKILL_ADVANCEMENT_CLASS sac, unsigned int pp) .text:005C8440 ?SkillLevelFromExperience@ExperienceSystem@@SAKW4SKILL_ADVANCEMENT_CLASS@@K@Z

        // ExperienceSystem.XPToString:
        public static void XPToString(UInt64 _xp, char* _output_str) => ((delegate* unmanaged[Cdecl]<UInt64, char*, void>)0x005C92B0)(_xp, _output_str); // .text:005C82D0 ; void __cdecl ExperienceSystem::XPToString(unsigned __int64 _xp, char *_output_str) .text:005C82D0 ?XPToString@ExperienceSystem@@SAX_KPAD@Z

        // Globals:
        // public static Single* AUGMENTATION_BONUS_XP_BOOST = (Single*)0xDEADBEEF; // .data:00822590 ; float ExperienceSystem::AUGMENTATION_BONUS_XP_BOOST .data:00822590 ?AUGMENTATION_BONUS_XP_BOOST@ExperienceSystem@@2MA
    }
