...
namespace AcClient {
    ...
    public unsafe struct CInputHandler {
        public CInputHandlerVtbl* vfptr;
    };
    public unsafe struct CInputHandlerVtbl {
        [UnmanagedFunctionPointer(CallingConvention.ThisCall)] public delegate void ActionHandler(CInputHandler* This, InputEvent* a2); // void(__thiscall *ActionHandler)(CInputHandler *this, InputEvent *);
        [UnmanagedFunctionPointer(CallingConvention.ThisCall)] public delegate void MouseMoveHandler(CInputHandler* This, Int32 a2, Int32 a3); // void(__thiscall *MouseMoveHandler)(CInputHandler *this, Int32, Int32);
        [UnmanagedFunctionPointer(CallingConvention.ThisCall)] public delegate void MouseLookHandler(CInputHandler* This, Int32 a2, Int32 a3); // void(__thiscall *MouseLookHandler)(CInputHandler *this, Int32, Int32);
        [UnmanagedFunctionPointer(CallingConvention.ThisCall)] public delegate void FocusSwitchHandler(CInputHandler* This, bool a2, Int32 a3); // void(__thiscall *FocusSwitchHandler)(CInputHandler *this, bool, Int32);
        [UnmanagedFunctionPointer(CallingConvention.ThisCall)] public delegate void CharacterHandler(CInputHandler* This, UInt16 a2); // void(__thiscall *CharacterHandler)(CInputHandler *this, wChar_t);
        [UnmanagedFunctionPointer(CallingConvention.ThisCall)] public delegate bool KeyHitHandler(CInputHandler* This, QualifiedControl* a2, UInt32* a3); // bool(__thiscall *KeyHitHandler)(CInputHandler *this, QualifiedControl *, UInt32 *);
    };
    ...
    public unsafe struct IInputActionCallback {
        public IInputActionCallbackVtbl* vfptr;
        public static UInt32[] UInt32s = { 1, 2, 3, 4 };
    };
    public unsafe struct IInputActionCallbackVtbl {
        [UnmanagedFunctionPointer(CallingConvention.ThisCall)] public delegate void* __vecDelDtor(IInputActionCallback* This, UInt32 a2);                   // void *(__thiscall *__vecDelDtor)(IInputActionCallback *this, UInt32);
        [UnmanagedFunctionPointer(CallingConvention.ThisCall)] public delegate bool OnAction(IInputActionCallback* This, InputEvent* a2);                // bool (__thiscall *OnAction)(IInputActionCallback *this, InputEvent *);
        [UnmanagedFunctionPointer(CallingConvention.ThisCall)] public delegate CallbackLoseFocusResult OnLoseFocus(IInputActionCallback* This, UInt32 a2, UInt32 a3, UInt32 a4);  // CallbackLoseFocusResult (__thiscall *OnLoseFocus)(IInputActionCallback *this, const UInt32, UInt32, UInt32);
    };
    ...
    public unsafe struct ControlSpecification {
        ...
        /*
        U__Int32 m_idxDevice : 8;
        U__Int32 m_eSubControl : 8;
        U__Int32 m_ofsKey : 16;
        */
    };
