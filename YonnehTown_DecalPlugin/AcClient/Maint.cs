...
namespace AcClient {
    ...
    // public static ACCObjectMaint* This = (ACCObjectMaint*)*(Int32*)0x00842ADC; // CObjectMaint *CObjectMaint::s_pcInstance
    public unsafe struct ACCObjectMaint {
        public CObjectMaint cObjectMaint;
        public ObjDesc* player_objdesc;


        public void SetVisualDesc(CPhysicsObj* _object, VisualDesc* vdesc) => ((def_SetVisualDesc)Marshal.GetDelegateForFunctionPointer((IntPtr)0x005582A0, typeof(def_SetVisualDesc)))(ref this, _object, vdesc); // .text:005582A0 ; Int32 __stdcall ACCObjectMaint::SetVisualDesc(Int32, Single)
        [UnmanagedFunctionPointer(CallingConvention.ThisCall)] internal delegate void def_SetVisualDesc(ref ACCObjectMaint This, CPhysicsObj* _object, VisualDesc* vdesc); // void __stdcall ACCObjectMaint::SetVisualDesc(CPhysicsObj* _object, VisualDesc *vdesc);
        //

        public void SetPlayerVisualDesc(VisualDesc* new_player_vdesc) => ((def_SetPlayerVisualDesc)Marshal.GetDelegateForFunctionPointer((IntPtr)0x005582C0, typeof(def_SetPlayerVisualDesc)))(ref this, new_player_vdesc); // .text:005582C0 ; public: virtual void __thiscall ACCObjectMaint::SetPlayerVisualDesc(class VisualDesc *)
        [UnmanagedFunctionPointer(CallingConvention.ThisCall)] internal delegate void def_SetPlayerVisualDesc(ref ACCObjectMaint This, VisualDesc* new_player_vdesc); // void __thiscall ACCObjectMaint::SetPlayerVisualDesc(ACCObjectMaint *this, VisualDesc *new_player_vdesc); // idb
        //

        public ObjDesc* GetPlayerVisualDesc() => ((def_GetPlayerVisualDesc)Marshal.GetDelegateForFunctionPointer((IntPtr)0x00558320, typeof(def_GetPlayerVisualDesc)))(ref this); // .text:00558320 ; public: virtual class VisualDesc * __thiscall ACCObjectMaint::GetPlayerVisualDesc(void)const
        [UnmanagedFunctionPointer(CallingConvention.ThisCall)] internal delegate ObjDesc* def_GetPlayerVisualDesc(ref ACCObjectMaint This); // ObjDesc *__thiscall ACCObjectMaint::GetPlayerVisualDesc(ACCObjectMaint *this);
        //

        public Int32 DeleteObject(UInt32 object_id) => ((def_DeleteObject)Marshal.GetDelegateForFunctionPointer((IntPtr)0x00558330, typeof(def_DeleteObject)))(ref this, object_id); // .text:00558330 ; Int32 __stdcall ACCObjectMaint::DeleteObject(void *)
        [UnmanagedFunctionPointer(CallingConvention.ThisCall)] internal delegate Int32 def_DeleteObject(ref ACCObjectMaint This, UInt32 object_id); // Int32 __thiscall ACCObjectMaint::DeleteObject(ACCObjectMaint *this, UInt32 object_id); // idb
        //

        public ACCObjectMaint* dtor(UInt32 a2) => ((def_dtor)Marshal.GetDelegateForFunctionPointer((IntPtr)0x005584C0, typeof(def_dtor)))(ref this, a2); // .text:005584C0 ; Int32 __thiscall ACCObjectMaint::`scalar deleting destructor'(void *, Char)
        [UnmanagedFunctionPointer(CallingConvention.ThisCall)] internal delegate ACCObjectMaint* def_dtor(ref ACCObjectMaint This, UInt32 a2); // ACCObjectMaint *__thiscall ACCObjectMaint::`scalar deleting destructor'(ACCObjectMaint *this, UInt32 a2);
        //

        public void SetWeenieDesc(CWeenieObject* wobj, WeenieDesc* wdesc, Int32 _recreated) => ((def_SetWeenieDesc)Marshal.GetDelegateForFunctionPointer((IntPtr)0x00558660, typeof(def_SetWeenieDesc)))(ref this, wobj, wdesc, _recreated); // .text:00558660 ; public: virtual void __thiscall ACCObjectMaint::SetWeenieDesc(class CWeenieObject *,class WeenieDesc *,Int32)
        [UnmanagedFunctionPointer(CallingConvention.ThisCall)] internal delegate void def_SetWeenieDesc(ref ACCObjectMaint This, CWeenieObject* wobj, WeenieDesc* wdesc, Int32 _recreated); // void __thiscall ACCObjectMaint::SetWeenieDesc(ACCObjectMaint *this, CWeenieObject *wobj, WeenieDesc *wdesc, Int32 _recreated); // idb
        //

        public UInt32 CreateObject(UInt32 objectID, VisualDesc* vdesc, PhysicsDesc* physicsdesc, WeenieDesc* wdesc) => ((def_CreateObject)Marshal.GetDelegateForFunctionPointer((IntPtr)0x005594B0, typeof(def_CreateObject)))(ref this, objectID, vdesc, physicsdesc, wdesc); // .text:005594B0 ; Int32 __stdcall ACCObjectMaint::CreateObject(Int32, Single, Int32, Int32)
        [UnmanagedFunctionPointer(CallingConvention.ThisCall)] internal delegate UInt32 def_CreateObject(ref ACCObjectMaint This, UInt32 objectID, VisualDesc* vdesc, PhysicsDesc* physicsdesc, WeenieDesc* wdesc); // UInt32 __thiscall ACCObjectMaint::CreateObject(ACCObjectMaint *this, UInt32 objectID, VisualDesc *vdesc, PhysicsDesc *physicsdesc, WeenieDesc *wdesc);
        //

        public void ViewObjectContents(UInt32 object_id, PackableList<ContentProfile>* new_contents) => ((def_ViewObjectContents)Marshal.GetDelegateForFunctionPointer((IntPtr)0x005596B0, typeof(def_ViewObjectContents)))(ref this, object_id, new_contents); // .text:005596B0 ; public: void __thiscall ACCObjectMaint::ViewObjectContents(UInt32,class PackableList<class ContentProfile> const &)
        [UnmanagedFunctionPointer(CallingConvention.ThisCall)] internal delegate void def_ViewObjectContents(ref ACCObjectMaint This, UInt32 object_id, PackableList<ContentProfile>* new_contents); // void __thiscall ACCObjectMaint::ViewObjectContents(ACCObjectMaint *this, UInt32 object_id, PackableList<ContentProfile> *new_contents); // idb
        //

        public void StopViewingObjectContents(UInt32 object_id) => ((def_StopViewingObjectContents)Marshal.GetDelegateForFunctionPointer((IntPtr)0x00559770, typeof(def_StopViewingObjectContents)))(ref this, object_id); // .text:00559770 ; public: void __thiscall ACCObjectMaint::StopViewingObjectContents(UInt32)
        [UnmanagedFunctionPointer(CallingConvention.ThisCall)] internal delegate void def_StopViewingObjectContents(ref ACCObjectMaint This, UInt32 object_id); // void __thiscall ACCObjectMaint::StopViewingObjectContents(ACCObjectMaint *this, UInt32 object_id); // idb
        //

        public void UpdateObjectInventory(UInt32 object_id, PackableList<InventoryPlacement>* new_inv) => ((def_UpdateObjectInventory)Marshal.GetDelegateForFunctionPointer((IntPtr)0x0055A190, typeof(def_UpdateObjectInventory)))(ref this, object_id, new_inv); // .text:0055A190 ; public: void __thiscall ACCObjectMaint::UpdateObjectInventory(UInt32,class PackableList<class InventoryPlacement> const &)
        [UnmanagedFunctionPointer(CallingConvention.ThisCall)] internal delegate void def_UpdateObjectInventory(ref ACCObjectMaint This, UInt32 object_id, PackableList<InventoryPlacement>* new_inv); // void __thiscall ACCObjectMaint::UpdateObjectInventory(ACCObjectMaint *this, UInt32 object_id, PackableList<InventoryPlacement> *new_inv); // idb
        //
    };
