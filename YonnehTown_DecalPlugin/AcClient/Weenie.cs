...
namespace AcClient {
    ...
    public unsafe struct CACQualities {
        ...
        // CACQualities.`vector deleting destructor'`adjustor{56}' :
        // (ERR) .text:00593F10 ; [thunk]:public: virtual void * __thiscall CACQualities::`vector deleting destructor'`adjustor{56}' (unsigned int) .text:00593F10 ??_ECACQualities@@WDI@AEPAXI@Z
        ...
        // CACQualities.UnPack`adjustor{8}' :
        // (ERR) .text:00594760 ; [thunk]:public: virtual int __thiscall CACQualities::UnPack`adjustor{8}' (void * &,unsigned int) .text:00594760 ?UnPack@CACQualities@@W7AEHAAPAXI@Z
        ...
        // CACQualities.Pack`adjustor{8}' :
        // (ERR) .text:005941C0 ; [thunk]:public: virtual unsigned int __thiscall CACQualities::Pack`adjustor{8}' (void * &,unsigned int) .text:005941C0 ?Pack@CACQualities@@W7AEIAAPAXI@Z
        ...
        // CACQualities.`scalar deleting destructor':
        // (ERR) .text:005946C0 ; int __thiscall CACQualities::`scalar deleting destructor'(void *, char) .text:005946C0 ??_GCACQualities@@UAEPAXI@Z
    ...
    public unsafe struct Skill {
        ...
        public override string ToString() => $"a0(PackObj):{a0}, _sac(SKILL_ADVANCEMENT_CLASS):{_sac}, _pp:{_pp:X8}, _init_level:{_init_level:X8}, _level_from_pp:{_level_from_pp:X8}, _resistance_of_last_check(int):{_resistance_of_last_check}, _last_used_time:{_last_used_time:n5}";
    ...
    public unsafe struct AppraisalProfile {
        ...
        public void __Ctor() => ((delegate* unmanaged[Thiscall]<ref AppraisalProfile, void>)0x005B4350)(ref this); // .text:005B32A0 ; void __thiscall AppraisalProfile::AppraisalProfile(AppraisalProfile *this) .text:005B32A0 ??0AppraisalProfile@@QAE@XZ

        // AppraisalProfile.operator_equals:
        public AppraisalProfile* operator_equals() => ((delegate* unmanaged[Thiscall]<ref AppraisalProfile, AppraisalProfile*>)0x005B51B0)(ref this); // .text:005B4100 ; public: class AppraisalProfile & __thiscall AppraisalProfile::operator=(class AppraisalProfile const &) .text:005B4100 ??4AppraisalProfile@@QAEAAV0@ABV0@@Z
        ...
        public AMMO_TYPE GetHookedItemAmmoType() => ((delegate* unmanaged[Thiscall]<ref AppraisalProfile, AMMO_TYPE>)0x005B4080)(ref this); // .text:005B2FD0 ; AMMO_TYPE __thiscall AppraisalProfile::GetHookedItemAmmoType(AppraisalProfile *this) .text:005B2FD0 ?GetHookedItemAmmoType@AppraisalProfile@@QBE?AW4AMMO_TYPE@@XZ

        // AppraisalProfile.GetHookedItemValidLocations:
        public UInt32 GetHookedItemValidLocations() => ((delegate* unmanaged[Thiscall]<ref AppraisalProfile, UInt32>)0x005B4070)(ref this); // .text:005B2FC0 ; unsigned int __thiscall AppraisalProfile::GetHookedItemValidLocations(AppraisalProfile *this) .text:005B2FC0 ?GetHookedItemValidLocations@AppraisalProfile@@QBEKXZ

        // AppraisalProfile.InqArmor:
        public int InqArmor(ArmorProfile* aap) => ((delegate* unmanaged[Thiscall]<ref AppraisalProfile, ArmorProfile*, int>)0x005B4420)(ref this, aap); // .text:005B3370 ; int __thiscall AppraisalProfile::InqArmor(AppraisalProfile *this, ArmorProfile *aap) .text:005B3370 ?InqArmor@AppraisalProfile@@QBEHAAVArmorProfile@@@Z

        // AppraisalProfile.InqBool:
        public int InqBool(UInt32 stype, int* retval) => ((delegate* unmanaged[Thiscall]<ref AppraisalProfile, UInt32, int*, int>)0x005B4940)(ref this, stype, retval); // .text:005B3890 ; int __thiscall AppraisalProfile::InqBool(AppraisalProfile *this, unsigned int stype, int *retval) .text:005B3890 ?InqBool@AppraisalProfile@@QBEHKAAH@Z

        // AppraisalProfile.InqCreature:
        public int InqCreature(CreatureAppraisalProfile* cap) => ((delegate* unmanaged[Thiscall]<ref AppraisalProfile, CreatureAppraisalProfile*, int>)0x005B3CA0)(ref this, cap); // .text:005B2BF0 ; int __thiscall AppraisalProfile::InqCreature(AppraisalProfile *this, CreatureAppraisalProfile *cap) .text:005B2BF0 ?InqCreature@AppraisalProfile@@QBEHAAVCreatureAppraisalProfile@@@Z

        // AppraisalProfile.InqDataID:
        public int InqDataID(UInt32 stype, UInt32* retval) => ((delegate* unmanaged[Thiscall]<ref AppraisalProfile, UInt32, UInt32*, int>)0x005B49A0)(ref this, stype, retval); // .text:005B38F0 ; int __thiscall AppraisalProfile::InqDataID(AppraisalProfile *this, unsigned int stype, IDClass<_tagDataID,32,0> *retval) .text:005B38F0 ?InqDataID@AppraisalProfile@@QBEHKAAV?$IDClass@U_tagDataID@@$0CA@$0A@@@@Z

        // AppraisalProfile.InqFloat:
        public int InqFloat(UInt32 stype, Double* retval) => ((delegate* unmanaged[Thiscall]<ref AppraisalProfile, UInt32, Double*, int>)0x005B4970)(ref this, stype, retval); // .text:005B38C0 ; int __thiscall AppraisalProfile::InqFloat(AppraisalProfile *this, unsigned int stype, long double *retval) .text:005B38C0 ?InqFloat@AppraisalProfile@@QBEHKAAN@Z

        // AppraisalProfile.InqFloatEnchantmentMod:
        public int InqFloatEnchantmentMod(UInt32 stype, int* raised) => ((delegate* unmanaged[Thiscall]<ref AppraisalProfile, UInt32, int*, int>)0x005B3D20)(ref this, stype, raised); // .text:005B2C70 ; int __thiscall AppraisalProfile::InqFloatEnchantmentMod(AppraisalProfile *this, unsigned int stype, int *raised) .text:005B2C70 ?InqFloatEnchantmentMod@AppraisalProfile@@QBEHKAAH@Z

        // AppraisalProfile.InqInt64:
        public int InqInt64(UInt32 stype, Int64* retval) => ((delegate* unmanaged[Thiscall]<ref AppraisalProfile, UInt32, Int64*, int>)0x005B4910)(ref this, stype, retval); // .text:005B3860 ; int __thiscall AppraisalProfile::InqInt64(AppraisalProfile *this, unsigned int stype, __int64 *retval) .text:005B3860 ?InqInt64@AppraisalProfile@@QBEHKAA_J@Z

        // AppraisalProfile.InqInt:
        public int InqInt(UInt32 stype, int* retval) => ((delegate* unmanaged[Thiscall]<ref AppraisalProfile, UInt32, int*, int>)0x005B48E0)(ref this, stype, retval); // .text:005B3830 ; int __thiscall AppraisalProfile::InqInt(AppraisalProfile *this, unsigned int stype, int *retval) .text:005B3830 ?InqInt@AppraisalProfile@@QBEHKAAJ@Z

        // AppraisalProfile.InqIntEnchantmentMod:
        public int InqIntEnchantmentMod(UInt32 stype, int* raised) => ((delegate* unmanaged[Thiscall]<ref AppraisalProfile, UInt32, int*, int>)0x005B3CC0)(ref this, stype, raised); // .text:005B2C10 ; int __thiscall AppraisalProfile::InqIntEnchantmentMod(AppraisalProfile *this, unsigned int stype, int *raised) .text:005B2C10 ?InqIntEnchantmentMod@AppraisalProfile@@QBEHKAAH@Z

        // AppraisalProfile.InqString:
        public int InqString(UInt32 stype, AC1Legacy.PStringBase<char>* retval) => ((delegate* unmanaged[Thiscall]<ref AppraisalProfile, UInt32, AC1Legacy.PStringBase<char>*, int>)0x005B4A00)(ref this, stype, retval); // .text:005B3950 ; int __thiscall AppraisalProfile::InqString(AppraisalProfile *this, unsigned int stype, AC1Legacy::PStringBase<char> *retval) .text:005B3950 ?InqString@AppraisalProfile@@QBEHKAAV?$PStringBase@D@AC1Legacy@@@Z

        // AppraisalProfile.InqWeapon:
        public int InqWeapon(WeaponProfile* wap) => ((delegate* unmanaged[Thiscall]<ref AppraisalProfile, WeaponProfile*, int>)0x005B48C0)(ref this, wap); // .text:005B3810 ; int __thiscall AppraisalProfile::InqWeapon(AppraisalProfile *this, WeaponProfile *wap) .text:005B3810 ?InqWeapon@AppraisalProfile@@QBEHAAVWeaponProfile@@@Z

        // AppraisalProfile.IsHookedItemHealer:
        public int IsHookedItemHealer() => ((delegate* unmanaged[Thiscall]<ref AppraisalProfile, int>)0x005B4050)(ref this); // .text:005B2FA0 ; int __thiscall AppraisalProfile::IsHookedItemHealer(AppraisalProfile *this) .text:005B2FA0 ?IsHookedItemHealer@AppraisalProfile@@QBEHXZ

        // AppraisalProfile.IsHookedItemInscribable:
        public int IsHookedItemInscribable() => ((delegate* unmanaged[Thiscall]<ref AppraisalProfile, int>)0x005B4040)(ref this); // .text:005B2F90 ; int __thiscall AppraisalProfile::IsHookedItemInscribable(AppraisalProfile *this) .text:005B2F90 ?IsHookedItemInscribable@AppraisalProfile@@QBEHXZ

        // AppraisalProfile.IsHookedItemLockpick:
        public int IsHookedItemLockpick() => ((delegate* unmanaged[Thiscall]<ref AppraisalProfile, int>)0x005B4060)(ref this); // .text:005B2FB0 ; int __thiscall AppraisalProfile::IsHookedItemLockpick(AppraisalProfile *this) .text:005B2FB0 ?IsHookedItemLockpick@AppraisalProfile@@QBEHXZ

        // AppraisalProfile.Pack:
        public UInt32 Pack(void** addr, UInt32 size) => ((delegate* unmanaged[Thiscall]<ref AppraisalProfile, void**, UInt32, UInt32>)0x005B4470)(ref this, addr, size); // .text:005B33C0 ; unsigned int __thiscall AppraisalProfile::Pack(AppraisalProfile *this, void **addr, unsigned int size) .text:005B33C0 ?Pack@AppraisalProfile@@UAEIAAPAXI@Z

        // AppraisalProfile.SetPackHeader:
        public void SetPackHeader(UInt32* bitfield) => ((delegate* unmanaged[Thiscall]<ref AppraisalProfile, UInt32*, void>)0x005B4090)(ref this, bitfield); // .text:005B2FE0 ; void __thiscall AppraisalProfile::SetPackHeader(AppraisalProfile *this, unsigned int *bitfield) .text:005B2FE0 ?SetPackHeader@AppraisalProfile@@IAEXAAK@Z

        // AppraisalProfile.UnPack:
        public int UnPack(void** addr, UInt32 size) => ((delegate* unmanaged[Thiscall]<ref AppraisalProfile, void**, UInt32, int>)0x005B4A30)(ref this, addr, size); // .text:005B3980 ; int __thiscall AppraisalProfile::UnPack(AppraisalProfile *this, void **addr, unsigned int size) .text:005B3980 ?UnPack@AppraisalProfile@@UAEHAAPAXI@Z

        // AppraisalProfile.pack_size:
        public UInt32 pack_size() => ((delegate* unmanaged[Thiscall]<ref AppraisalProfile, UInt32>)0x005B4180)(ref this); // .text:005B30D0 ; unsigned int __thiscall AppraisalProfile::pack_size(AppraisalProfile *this) .text:005B30D0 ?pack_size@AppraisalProfile@@IAEIXZ
