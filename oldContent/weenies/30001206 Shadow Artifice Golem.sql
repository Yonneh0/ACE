DELETE FROM `weenie` WHERE `class_Id` = 30001206;

INSERT INTO `weenie` (`class_Id`, `class_Name`, `type`, `last_Modified`)
VALUES (30001206, 'ace30001206-shadowartificegolem', 10, '2025-01-25 08:52:04') /* Creature */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (30001206,   1,         16) /* ItemType - Creature */
     , (30001206,   3,         13) /* PaletteTemplate - Purple */
     , (30001206,   6,        255) /* ItemsCapacity */
     , (30001206,   7,        255) /* ContainersCapacity */
     , (30001206,  16,         32) /* ItemUseable - Remote */
     , (30001206,  25,        200) /* Level */
     , (30001206,  93,    6292504) /* PhysicsState - ReportCollisions, IgnoreCollisions, Gravity, ReportCollisionsAsEnvironment, EdgeSlide */
     , (30001206,  95,          8) /* RadarBlipColor - Yellow */
     , (30001206, 113,          2) /* Gender - Female */
     , (30001206, 133,          4) /* ShowableOnRadar - ShowAlways */
     , (30001206, 134,         16) /* PlayerKillerStatus - RubberGlue */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (30001206,   1, True ) /* Stuck */
     , (30001206,   8, True ) /* AllowGive */
     , (30001206,  11, True ) /* IgnoreCollisions */
     , (30001206,  12, True ) /* ReportCollisions */
     , (30001206,  14, True ) /* GravityStatus */
     , (30001206,  19, False) /* Attackable */
     , (30001206,  41, True ) /* ReportCollisionsAsEnvironment */
     , (30001206,  42, True ) /* AllowEdgeSlide */
     , (30001206,  52, True ) /* AiImmobile */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (30001206,   1,       5) /* HeartbeatInterval */
     , (30001206,   2,       0) /* HeartbeatTimestamp */
     , (30001206,  39, 1.2000000476837158) /* DefaultScale */
     , (30001206,  54,       3) /* UseRadius */;

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (30001206,   1, 'Shadow Artifice Golem') /* Name */;

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (30001206,   1,   33556440) /* Setup */
     , (30001206,   2,  150995073) /* MotionTable */
     , (30001206,   3,  536870933) /* SoundTable */
     , (30001206,   4,  805306376) /* CombatTable */
     , (30001206,   6,   67114905) /* PaletteBase */
     , (30001206,   8,  100667940) /* Icon */
     , (30001206,  22,  872415322) /* PhysicsEffectTable */;

INSERT INTO `weenie_properties_attribute` (`object_Id`, `type`, `init_Level`, `level_From_C_P`, `c_P_Spent`)
VALUES (30001206,   1,  60, 0, 0) /* Strength */
     , (30001206,   2,  70, 0, 0) /* Endurance */
     , (30001206,   3,  80, 0, 0) /* Quickness */
     , (30001206,   4,  50, 0, 0) /* Coordination */
     , (30001206,   5, 120, 0, 0) /* Focus */
     , (30001206,   6, 130, 0, 0) /* Self */;

INSERT INTO `weenie_properties_attribute_2nd` (`object_Id`, `type`, `init_Level`, `level_From_C_P`, `c_P_Spent`, `current_Level`)
VALUES (30001206,   1,    10, 0, 0, 45) /* MaxHealth */
     , (30001206,   3,    10, 0, 0, 80) /* MaxStamina */
     , (30001206,   5,    10, 0, 0, 140) /* MaxMana */;

INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (30001206,  6 /* Give */,      1, 30001210, NULL, NULL, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (30001206,  7 /* Use */,      1, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (30001206, 22 /* TestSuccess */,      1, NULL, NULL, NULL, 'Xptest', NULL, NULL, NULL);
...
VALUES (@parent_id,  0,  18 /* DirectBroadcast */, 1, 1, NULL, 'The golem takes your Coalesced Artifice and grabs you by the hand. Its grasp is cold and firm.', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL)
     ...
     , (@parent_id,  5,   3 /* Give */, 0.5, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1 /* Contain */, 30001201, 1, 0, 1, False, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL)
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (30001206, 23 /* TestFailure */,      1, NULL, NULL, NULL, 'Xptest', NULL, NULL, NULL);
