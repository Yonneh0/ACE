DELETE FROM `weenie` WHERE `class_Id` = 30001205;

INSERT INTO `weenie` (`class_Id`, `class_Name`, `type`, `last_Modified`)
VALUES (30001205, 'ace30001205-neutralartificegolem', 10, '2025-01-25 08:52:04') /* Creature */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (30001205,   1,         16) /* ItemType - Creature */
     , (30001205,   2,         13) /* CreatureType - Golem */
     , (30001205,   3,          2) /* PaletteTemplate - Blue */
     , (30001205,   6,        255) /* ItemsCapacity */
     , (30001205,   7,        255) /* ContainersCapacity */
     , (30001205,  16,         32) /* ItemUseable - Remote */
     , (30001205,  25,        200) /* Level */
     , (30001205,  93,    6292504) /* PhysicsState - ReportCollisions, IgnoreCollisions, Gravity, ReportCollisionsAsEnvironment, EdgeSlide */
     , (30001205,  95,          8) /* RadarBlipColor - Yellow */
     , (30001205, 113,          2) /* Gender - Female */
     , (30001205, 133,          4) /* ShowableOnRadar - ShowAlways */
     , (30001205, 134,         16) /* PlayerKillerStatus - RubberGlue */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (30001205,   1, True ) /* Stuck */
     , (30001205,   8, True ) /* AllowGive */
     , (30001205,  11, True ) /* IgnoreCollisions */
     , (30001205,  12, True ) /* ReportCollisions */
     , (30001205,  14, True ) /* GravityStatus */
     , (30001205,  19, False) /* Attackable */
     , (30001205,  41, True ) /* ReportCollisionsAsEnvironment */
     , (30001205,  42, True ) /* AllowEdgeSlide */
     , (30001205,  52, True ) /* AiImmobile */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (30001205,   1,       5) /* HeartbeatInterval */
     , (30001205,   2,       0) /* HeartbeatTimestamp */
     , (30001205,  39, 1.2000000476837158) /* DefaultScale */
     , (30001205,  54,       3) /* UseRadius */;

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (30001205,   1, 'Neutral Artifice Golem') /* Name */;

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (30001205,   1,   33557484) /* Setup */
     , (30001205,   2,  150995073) /* MotionTable */
     , (30001205,   3,  536870933) /* SoundTable */
     , (30001205,   4,  805306376) /* CombatTable */
     , (30001205,   6,   67113782) /* PaletteBase */
     , (30001205,   7,  268436246) /* ClothingBase */
     , (30001205,   8,  100667940) /* Icon */
     , (30001205,  22,  872415323) /* PhysicsEffectTable */;

INSERT INTO `weenie_properties_attribute` (`object_Id`, `type`, `init_Level`, `level_From_C_P`, `c_P_Spent`)
VALUES (30001205,   1,  60, 0, 0) /* Strength */
     , (30001205,   2,  70, 0, 0) /* Endurance */
     , (30001205,   3,  80, 0, 0) /* Quickness */
     , (30001205,   4,  50, 0, 0) /* Coordination */
     , (30001205,   5, 120, 0, 0) /* Focus */
     , (30001205,   6, 130, 0, 0) /* Self */;

INSERT INTO `weenie_properties_attribute_2nd` (`object_Id`, `type`, `init_Level`, `level_From_C_P`, `c_P_Spent`, `current_Level`)
VALUES (30001205,   1,    10, 0, 0, 45) /* MaxHealth */
     , (30001205,   3,    10, 0, 0, 80) /* MaxStamina */
     , (30001205,   5,    10, 0, 0, 140) /* MaxMana */;

INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (30001205,  6 /* Give */,      1, 30001210, NULL, NULL, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (30001205,  7 /* Use */,      1, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (30001205, 22 /* TestSuccess */,      1, NULL, NULL, NULL, 'Xptest', NULL, NULL, NULL);
...
VALUES (@parent_id,  0,  18 /* DirectBroadcast */, 1, 1, NULL, 'The golem takes your Coalesced Artifice and grabs you by the hand. Its grasp is cold and firm.', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL)
     ...
     , (@parent_id,  5,   3 /* Give */, 0.5, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1 /* Contain */, 30001200, 1, 0, 1, False, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL)
...
INSERT INTO `weenie_properties_emote` (`object_Id`, `category`, `probability`, `weenie_Class_Id`, `style`, `substyle`, `quest`, `vendor_Type`, `min_Health`, `max_Health`)
VALUES (30001205, 23 /* TestFailure */,      1, NULL, NULL, NULL, 'Xptest', NULL, NULL, NULL);
